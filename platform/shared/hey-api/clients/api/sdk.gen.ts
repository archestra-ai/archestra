 ...
 */
export const listDeletedItems = <ThrowOnError extends boolean = false>(options?: Options<ListDeletedItemsData, ThrowOnError>) => (options?.client ?? client).get<ListDeletedItemsResponses, ListDeletedItemsErrors, ThrowOnError>({ url: '/api/deleted-items', ...options });

/**
 * Restore a soft-deleted entity from Deleted Items
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const restoreDeletedItem = <ThrowOnError extends boolean = false>(options: Options<RestoreDeletedItemData, ThrowOnError>) => (options.client ?? client).post<RestoreDeletedItemResponses, RestoreDeletedItemErrors, ThrowOnError>({ url: '/api/deleted-items/{entityType}/{id}/restore', ...options });
 ...
 * `organizationSettings:update`: Customize organization appearance, authentication, etc
 */
export const purgeDeletedItem = <ThrowOnError extends boolean = false>(options: Options<PurgeDeletedItemData, ThrowOnError>) => (options.client ?? client).delete<PurgeDeletedItemResponses, PurgeDeletedItemErrors, ThrowOnError>({ url: '/api/deleted-items/{entityType}/{id}', ...options });
 ...
 * `organizationSettings:update`: Customize organization appearance, authentication, etc
 */
export const updateDeletedItemsSettings = <ThrowOnError extends boolean = false>(options: Options<UpdateDeletedItemsSettingsData, ThrowOnError>) => (options.client ?? client).patch<UpdateDeletedItemsSettingsResponses, UpdateDeletedItemsSettingsErrors, ThrowOnError>({
