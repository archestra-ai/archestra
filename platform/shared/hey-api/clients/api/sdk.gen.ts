 ...
 * `app:read`: View and run MCP Apps within your scope (org, your teams, your own)
 */
export const getAppAssignableBuiltinTools = <ThrowOnError extends boolean = false>(options?: Options<GetAppAssignableBuiltinToolsData, ThrowOnError>) => (options?.client ?? client).get<GetAppAssignableBuiltinToolsResponses, GetAppAssignableBuiltinToolsErrors, ThrowOnError>({ url: '/api/apps/assignable-builtin-tools', ...options });
