...
function Input({
  ...
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        // text-sm at every breakpoint (not shadcn's stock `text-base md:text-sm`)
        // so inputs match the selects they sit next to. The trade-off: iOS
        // Safari auto-zooms focused inputs whose font-size is under 16px.
