 ...
 * None (no additional RBAC permission required)
 */
export const getCompactOpenApi = <ThrowOnError extends boolean = false>(options?: Options<GetCompactOpenApiData, ThrowOnError>) => (options?.client ?? client).get<GetCompactOpenApiResponses, unknown, ThrowOnError>({ url: '/api/openapi-compact', ...options });
