...
export type GetChatApiKeysResponses = {
    ...
    200: Array<{
        ...
        organizationId: string;
        name: string;
        provider: 'anthropic' | 'bedrock' | 'cerebras' | 'cohere' | 'gemini' | 'groq' | 'mistral' | 'openai' | 'vllm' | 'ollama' | 'zhipuai';
...
export type GetModelsWithApiKeysResponses = {
    ...
    200: Array<{
        id: string;
        externalId: string;
        provider: 'openai' | 'gemini' | 'anthropic' | 'bedrock' | 'cohere' | 'cerebras' | 'groq' | 'mistral' | 'vllm' | 'ollama' | 'zhipuai';
        modelId: string;
        description: string | null;
        contextLength: number | null;
        inputModalities: Array<'text' | 'image' | 'audio' | 'video' | 'pdf'> | null;
...
export type GetChatConversationsResponses = {
    ...
    200: Array<{
        ...
        selectedProvider: 'anthropic' | 'bedrock' | 'cerebras' | 'cohere' | 'gemini' | 'groq' | 'mistral' | 'openai' | 'vllm' | 'ollama' | 'zhipuai';
