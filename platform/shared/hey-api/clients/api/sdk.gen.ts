 ...
 */
export const getEvalSuites = <ThrowOnError extends boolean = false>(options?: Options<GetEvalSuitesData, ThrowOnError>) => (options?.client ?? client).get<GetEvalSuitesResponses, GetEvalSuitesErrors, ThrowOnError>({ url: '/api/eval-suites', ...options });
 ...
 */
export const createEvalSuite = <ThrowOnError extends boolean = false>(options: Options<CreateEvalSuiteData, ThrowOnError>) => (options.client ?? client).post<CreateEvalSuiteResponses, CreateEvalSuiteErrors, ThrowOnError>({
    url: '/api/eval-suites',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const deleteEvalSuite = <ThrowOnError extends boolean = false>(options: Options<DeleteEvalSuiteData, ThrowOnError>) => (options.client ?? client).delete<DeleteEvalSuiteResponses, DeleteEvalSuiteErrors, ThrowOnError>({ url: '/api/eval-suites/{id}', ...options });
 ...
 * `eval:read`: View eval suites, cases, runs and their results
 */
export const getEvalSuite = <ThrowOnError extends boolean = false>(options: Options<GetEvalSuiteData, ThrowOnError>) => (options.client ?? client).get<GetEvalSuiteResponses, GetEvalSuiteErrors, ThrowOnError>({ url: '/api/eval-suites/{id}', ...options });
 ...
 */
export const updateEvalSuite = <ThrowOnError extends boolean = false>(options: Options<UpdateEvalSuiteData, ThrowOnError>) => (options.client ?? client).put<UpdateEvalSuiteResponses, UpdateEvalSuiteErrors, ThrowOnError>({
    url: '/api/eval-suites/{id}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Soft-delete several eval suites in one request. An id the caller cannot see is reported in `failed` and the rest of the batch still applies.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `eval:delete`: Delete eval suites
 */
export const bulkDeleteEvalSuites = <ThrowOnError extends boolean = false>(options: Options<BulkDeleteEvalSuitesData, ThrowOnError>) => (options.client ?? client).delete<BulkDeleteEvalSuitesResponses, BulkDeleteEvalSuitesErrors, ThrowOnError>({
...
/**
 * List an eval suite's cases in position order
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `eval:read`: View eval suites, cases, runs and their results
 */
export const getEvalSuiteCases = <ThrowOnError extends boolean = false>(options: Options<GetEvalSuiteCasesData, ThrowOnError>) => (options.client ?? client).get<GetEvalSuiteCasesResponses, GetEvalSuiteCasesErrors, ThrowOnError>({ url: '/api/eval-suites/{id}/cases', ...options });

/**
 * Add a case to an eval suite (max 500 cases per suite)
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `eval:update`: Modify eval suites and their cases
 */
export const createEvalSuiteCase = <ThrowOnError extends boolean = false>(options: Options<CreateEvalSuiteCaseData, ThrowOnError>) => (options.client ?? client).post<CreateEvalSuiteCaseResponses, CreateEvalSuiteCaseErrors, ThrowOnError>({
    url: '/api/eval-suites/{id}/cases',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Delete several cases of one eval suite in one request. An id that does not belong to this suite (or the caller's organization) is reported in `failed` and the rest of the batch still applies.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `eval:update`: Modify eval suites and their cases
 */
export const bulkDeleteEvalCases = <ThrowOnError extends boolean = false>(options: Options<BulkDeleteEvalCasesData, ThrowOnError>) => (options.client ?? client).delete<BulkDeleteEvalCasesResponses, BulkDeleteEvalCasesErrors, ThrowOnError>({
 ...
 * `eval:update`: Modify eval suites and their cases
 */
export const deleteEvalCase = <ThrowOnError extends boolean = false>(options: Options<DeleteEvalCaseData, ThrowOnError>) => (options.client ?? client).delete<DeleteEvalCaseResponses, DeleteEvalCaseErrors, ThrowOnError>({ url: '/api/eval-cases/{id}', ...options });
 ...
 * `eval:update`: Modify eval suites and their cases
 */
export const updateEvalCase = <ThrowOnError extends boolean = false>(options: Options<UpdateEvalCaseData, ThrowOnError>) => (options.client ?? client).put<UpdateEvalCaseResponses, UpdateEvalCaseErrors, ThrowOnError>({
    url: '/api/eval-cases/{id}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 */
export const createEvalRun = <ThrowOnError extends boolean = false>(options: Options<CreateEvalRunData, ThrowOnError>) => (options.client ?? client).post<CreateEvalRunResponses, CreateEvalRunErrors, ThrowOnError>({
    url: '/api/eval-suites/{id}/runs',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * `eval:read`: View eval suites, cases, runs and their results
 */
export const getEvalRuns = <ThrowOnError extends boolean = false>(options?: Options<GetEvalRunsData, ThrowOnError>) => (options?.client ?? client).get<GetEvalRunsResponses, GetEvalRunsErrors, ThrowOnError>({ url: '/api/eval-runs', ...options });
 ...
 * `eval:read`: View eval suites, cases, runs and their results
 */
export const getEvalRun = <ThrowOnError extends boolean = false>(options: Options<GetEvalRunData, ThrowOnError>) => (options.client ?? client).get<GetEvalRunResponses, GetEvalRunErrors, ThrowOnError>({ url: '/api/eval-runs/{id}', ...options });

/**
 * List an eval run's per-case results in position order
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `eval:read`: View eval suites, cases, runs and their results
 */
export const getEvalRunResults = <ThrowOnError extends boolean = false>(options: Options<GetEvalRunResultsData, ThrowOnError>) => (options.client ?? client).get<GetEvalRunResultsResponses, GetEvalRunResultsErrors, ThrowOnError>({ url: '/api/eval-runs/{id}/results', ...options });
 ...
 * `eval:execute`: Run eval suites against agents and cancel runs
 */
export const cancelEvalRun = <ThrowOnError extends boolean = false>(options: Options<CancelEvalRunData, ThrowOnError>) => (options.client ?? client).post<CancelEvalRunResponses, CancelEvalRunErrors, ThrowOnError>({ url: '/api/eval-runs/{id}/cancel', ...options });
