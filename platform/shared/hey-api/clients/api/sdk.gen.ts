...
/**
 * List a catalog item's config versions, newest first.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `mcpRegistry:read`: Browse the MCP server registry
 */
export const getInternalMcpCatalogItemVersions = <ThrowOnError extends boolean = false>(options: Options<GetInternalMcpCatalogItemVersionsData, ThrowOnError>) => (options.client ?? client).get<GetInternalMcpCatalogItemVersionsResponses, GetInternalMcpCatalogItemVersionsErrors, ThrowOnError>({ url: '/api/internal_mcp_catalog/{id}/versions', ...options });

/**
 * Get a specific config version of a catalog item.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `mcpRegistry:read`: Browse the MCP server registry
 */
export const getInternalMcpCatalogItemVersion = <ThrowOnError extends boolean = false>(options: Options<GetInternalMcpCatalogItemVersionData, ThrowOnError>) => (options.client ?? client).get<GetInternalMcpCatalogItemVersionResponses, GetInternalMcpCatalogItemVersionErrors, ThrowOnError>({ url: '/api/internal_mcp_catalog/{id}/versions/{version}', ...options });
