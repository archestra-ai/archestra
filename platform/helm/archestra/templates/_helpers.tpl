...
{{- end }}
{{/*
Enable distributed caching when configured.
Uses PostgreSQL for cache storage, enabling multi-pod deployments.
*/}}
{{- if .Values.archestra.distributedCache.enabled }}
- name: ARCHESTRA_DISTRIBUTED_CACHE
  value: "true"
{{- end }}
{{/*
