...
export const TOOL_RECALL_MEMORIES_SHORT_NAME = "recall_memories";
...
export const TOOL_SAVE_MEMORY_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_SAVE_MEMORY_SHORT_NAME}` as const;
export const TOOL_RECALL_MEMORIES_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_RECALL_MEMORIES_SHORT_NAME}` as const;
export const TOOL_DELETE_MEMORY_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_DELETE_MEMORY_SHORT_NAME}` as const;
