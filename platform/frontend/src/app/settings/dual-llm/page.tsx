      ...
      <div className="space-y-6">
        <div className="bg-card rounded-lg p-8 shadow-sm">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            The Dual LLM quarantine pattern protects your main agent from prompt
            injection attacks by isolating untrusted data in a separate agent
            that can only respond via structured multiple choice answers.{" "}
            <a
