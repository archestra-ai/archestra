...
export const ChatCompletionUsageSchema = z
  .object({
    ...
    completion_tokens_details: z
      .any()
      .optional()
      .describe("Detailed breakdown of completion tokens"),
  ...
  .object({
    ...
    message: z
      .object({
        ...
        reasoning_details: z.string().optional().describe("MiniMax thinking/reasoning content"),
        function_call: z
          .object({
            arguments: z.string(),
            name: z.string(),
          ...
          .nullable()
          .optional()
          .describe("Deprecated function call format"),
...
export const ChatCompletionRequestSchema = z
  .object({
    ...
    reasoning_split: z.boolean().optional().describe("Enable MiniMax reasoning/thinking split"),
  })
