...
INSERT INTO "virtual_api_key_provider_api_key" ("virtual_api_key_id", "provider", "chat_api_key_id", "created_at")
SELECT
  "virtual_api_keys"."id",
    ...
    (
      ...
      FROM (
        SELECT jsonb_build_object(
          ...
          'chatApiKeyId', "chat_api_keys"."id"::text
...
ALTER TABLE "virtual_api_key_provider_api_key" ADD CONSTRAINT "virtual_api_key_provider_api_key_chat_api_key_id_chat_api_keys_id_fk" FOREIGN KEY ("chat_api_key_id") REFERENCES "public"."chat_api_keys"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "idx_virtual_api_key_provider_api_key_id" ON "virtual_api_key_provider_api_key" USING btree ("chat_api_key_id");--> statement-breakpoint
