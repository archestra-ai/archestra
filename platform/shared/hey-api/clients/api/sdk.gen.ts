 ...
 * This route accepts either an LLM provider API key or a Virtual API Key. See [LLM Proxy Authentication](/docs/platform-llm-proxy-authentication).
 */
export const unifiedListModels = <ThrowOnError extends boolean = false>(options: Options<UnifiedListModelsData, ThrowOnError>) => (options.client ?? client).get<UnifiedListModelsResponses, unknown, ThrowOnError>({ url: '/v1/unified/models', ...options });
 ...
 * This route accepts either an LLM provider API key or a Virtual API Key. See [LLM Proxy Authentication](/docs/platform-llm-proxy-authentication).
 */
export const unifiedListModelsWithAgent = <ThrowOnError extends boolean = false>(options: Options<UnifiedListModelsWithAgentData, ThrowOnError>) => (options.client ?? client).get<UnifiedListModelsWithAgentResponses, unknown, ThrowOnError>({ url: '/v1/unified/{agentId}/models', ...options });
 ...
 * This route accepts either an LLM provider API key or a Virtual API Key. See [LLM Proxy Authentication](/docs/platform-llm-proxy-authentication).
 */
export const unifiedChatCompletionsWithDefaultAgent = <ThrowOnError extends boolean = false>(options: Options<UnifiedChatCompletionsWithDefaultAgentData, ThrowOnError>) => (options.client ?? client).post<UnifiedChatCompletionsWithDefaultAgentResponses, UnifiedChatCompletionsWithDefaultAgentErrors, ThrowOnError>({
 ...
 * This route accepts either an LLM provider API key or a Virtual API Key. See [LLM Proxy Authentication](/docs/platform-llm-proxy-authentication).
 */
export const unifiedChatCompletionsWithAgent = <ThrowOnError extends boolean = false>(options: Options<UnifiedChatCompletionsWithAgentData, ThrowOnError>) => (options.client ?? client).post<UnifiedChatCompletionsWithAgentResponses, UnifiedChatCompletionsWithAgentErrors, ThrowOnError>({
    url: '/v1/unified/{agentId}/chat/completions',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * This route accepts either an LLM provider API key or a Virtual API Key. See [LLM Proxy Authentication](/docs/platform-llm-proxy-authentication).
 */
export const unifiedResponsesWithDefaultAgent = <ThrowOnError extends boolean = false>(options: Options<UnifiedResponsesWithDefaultAgentData, ThrowOnError>) => (options.client ?? client).post<UnifiedResponsesWithDefaultAgentResponses, UnifiedResponsesWithDefaultAgentErrors, ThrowOnError>({
    url: '/v1/unified/responses',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * This route accepts either an LLM provider API key or a Virtual API Key. See [LLM Proxy Authentication](/docs/platform-llm-proxy-authentication).
 */
export const unifiedResponsesWithAgent = <ThrowOnError extends boolean = false>(options: Options<UnifiedResponsesWithAgentData, ThrowOnError>) => (options.client ?? client).post<UnifiedResponsesWithAgentResponses, UnifiedResponsesWithAgentErrors, ThrowOnError>({
    url: '/v1/unified/{agentId}/responses',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
