 ...
 *
 * Currently Vertex AI, Azure OpenAI (with Entra ID), Anthropic keyless auth,
 * and Bedrock (with IAM auth) qualify as keyless because they use provider or
 * cloud credentials instead of API keys.
 *
