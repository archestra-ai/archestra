...
/**
 * List LLM applications that can access the Model Router
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const getLlmApplications = <ThrowOnError extends boolean = false>(options?: Options<GetLlmApplicationsData, ThrowOnError>) => (options?.client ?? client).get<GetLlmApplicationsResponses, GetLlmApplicationsErrors, ThrowOnError>({ url: '/api/llm-applications', ...options });
 ...
 */
export const createLlmApplication = <ThrowOnError extends boolean = false>(options: Options<CreateLlmApplicationData, ThrowOnError>) => (options.client ?? client).post<CreateLlmApplicationResponses, CreateLlmApplicationErrors, ThrowOnError>({
 ...
 */
export const deleteLlmApplication = <ThrowOnError extends boolean = false>(options: Options<DeleteLlmApplicationData, ThrowOnError>) => (options.client ?? client).delete<DeleteLlmApplicationResponses, DeleteLlmApplicationErrors, ThrowOnError>({ url: '/api/llm-applications/{id}', ...options });

/**
 * Update an LLM application
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const updateLlmApplication = <ThrowOnError extends boolean = false>(options: Options<UpdateLlmApplicationData, ThrowOnError>) => (options.client ?? client).put<UpdateLlmApplicationResponses, UpdateLlmApplicationErrors, ThrowOnError>({
...
/**
 * Rotate an LLM application's client secret
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `llmApplication:update`: Modify LLM application registrations
 */
export const rotateLlmApplicationSecret = <ThrowOnError extends boolean = false>(options: Options<RotateLlmApplicationSecretData, ThrowOnError>) => (options.client ?? client).post<RotateLlmApplicationSecretResponses, RotateLlmApplicationSecretErrors, ThrowOnError>({ url: '/api/llm-applications/{id}/rotate-secret', ...options });
