 ...
 * `knowledgeSource:delete`: Delete Knowledge Bases and Connectors
 */
export const deleteKnowledgeBaseDocument = <ThrowOnError extends boolean = false>(options: Options<DeleteKnowledgeBaseDocumentData, ThrowOnError>) => (options.client ?? client).delete<DeleteKnowledgeBaseDocumentResponses, DeleteKnowledgeBaseDocumentErrors, ThrowOnError>({ url: '/api/knowledge-bases/{id}/documents/{docId}', ...options });
 ...
 * `knowledgeSource:read`: View Knowledge Bases and Connectors
 */
export const getKnowledgeBaseDocument = <ThrowOnError extends boolean = false>(options: Options<GetKnowledgeBaseDocumentData, ThrowOnError>) => (options.client ?? client).get<GetKnowledgeBaseDocumentResponses, GetKnowledgeBaseDocumentErrors, ThrowOnError>({ url: '/api/knowledge-bases/{id}/documents/{docId}', ...options });
