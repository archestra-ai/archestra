...
> = {
  ...
  [RouteId.AssignRoleToUser]: {
    organization: ["update"],
  },
  [RouteId.GetUserRoles]: {
    organization: ["read"],
  },
  [RouteId.GetUserRoleAssignment]: {
    organization: ["read"],
  },
  [RouteId.RemoveRoleFromUser]: {
    organization: ["update"],
  },
  [RouteId.GetUser]: {}, // Available to all authenticated users (can view own profile, admins can view any)
