...
| `reply_channel` | `"chat" \| "slack_dm"` | No | Where the scheduled task result should be delivered. Defaults to 'chat'. 'slack_dm' delivers to your connected DM when available; otherwise the task falls back to chat. |
