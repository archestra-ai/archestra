...
- Team MCP server installations depend on team membership; \`mcpServerInstallation:admin\` manages any team connection
- Organization-wide connections require \`mcpServerInstallation:admin\`

Deleting a team retains its MCP connections but removes access based on team membership. \`mcpServerInstallation:admin\` can still refresh, reauthenticate, reinstall, or revoke those connections. Each action also requires its usual MCP installation permission.
