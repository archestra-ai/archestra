 ...
 * See: https://console.groq.com/en/latest/features/openai_api.html
 */
...
function convertMcpImageBlocksToGroq(
  ...
  for (const item of content) {
    ...
    if (isMcpImageBlock(item)) {
      ...
      logger.info(
        ...
        "[GroqAdapter] Converting MCP image block to vLLM format",
      );
  ...
  logger.info(
    ...
    "[GroqAdapter] Converted MCP content to vLLM format",
  );
