/**
 * Grok API schemas - OpenAI-compatible
...
/**
 * Grok-specific Choice schema
 * content is optional when tool_calls are present
 */
const GrokChoiceSchema = z
  .object({
...
/**
 * Grok-specific ChatCompletionResponse schema
 */
export const ChatCompletionResponseSchema = z
  .object({
    id: z.string(),
    choices: z.array(GrokChoiceSchema),
    created: z.number(),
    model: z.string(),
