 ...
 * `mcpRegistry:read`: Browse the MCP server registry
 */
export const getInternalMcpCatalogUsage = <ThrowOnError extends boolean = false>(options?: Options<GetInternalMcpCatalogUsageData, ThrowOnError>) => (options?.client ?? client).get<GetInternalMcpCatalogUsageResponses, GetInternalMcpCatalogUsageErrors, ThrowOnError>({ url: '/api/internal_mcp_catalog/usage', ...options });
