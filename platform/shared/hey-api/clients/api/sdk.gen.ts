...
/**
 * List memory items visible to the requesting user
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const listMemory = <ThrowOnError extends boolean = false>(options?: Options<ListMemoryData, ThrowOnError>) => (options?.client ?? client).get<ListMemoryResponses, ListMemoryErrors, ThrowOnError>({ url: '/api/memory', ...options });
 ...
 * `memory:read`: View durable memory items in authorized scopes
 */
export const getMemoryStats = <ThrowOnError extends boolean = false>(options?: Options<GetMemoryStatsData, ThrowOnError>) => (options?.client ?? client).get<GetMemoryStatsResponses, GetMemoryStatsErrors, ThrowOnError>({ url: '/api/memory/stats', ...options });
 ...
 */
export const listPendingMemory = <ThrowOnError extends boolean = false>(options?: Options<ListPendingMemoryData, ThrowOnError>) => (options?.client ?? client).get<ListPendingMemoryResponses, ListPendingMemoryErrors, ThrowOnError>({ url: '/api/memory/pending', ...options });
 ...
 */
export const deleteMemory = <ThrowOnError extends boolean = false>(options: Options<DeleteMemoryData, ThrowOnError>) => (options.client ?? client).delete<DeleteMemoryResponses, DeleteMemoryErrors, ThrowOnError>({ url: '/api/memory/{id}', ...options });
 ...
 * `memory:read`: View durable memory items in authorized scopes
 */
export const getMemory = <ThrowOnError extends boolean = false>(options: Options<GetMemoryData, ThrowOnError>) => (options.client ?? client).get<GetMemoryResponses, GetMemoryErrors, ThrowOnError>({ url: '/api/memory/{id}', ...options });

/**
 * Update a candidate memory item's content or metadata
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const updateMemory = <ThrowOnError extends boolean = false>(options: Options<UpdateMemoryData, ThrowOnError>) => (options.client ?? client).patch<UpdateMemoryResponses, UpdateMemoryErrors, ThrowOnError>({
    url: '/api/memory/{id}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
/**
 * Propose a superseding edit to an approved memory item
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `memory:update`: Update or archive durable memory items
 */
export const supersedeMemory = <ThrowOnError extends boolean = false>(options: Options<SupersedeMemoryData, ThrowOnError>) => (options.client ?? client).post<SupersedeMemoryResponses, SupersedeMemoryErrors, ThrowOnError>({
 ...
 * `memory:approve`: Approve or reject memory candidates
 */
export const approveMemory = <ThrowOnError extends boolean = false>(options: Options<ApproveMemoryData, ThrowOnError>) => (options.client ?? client).post<ApproveMemoryResponses, ApproveMemoryErrors, ThrowOnError>({ url: '/api/memory/{id}/approve', ...options });
 ...
 * `memory:approve`: Approve or reject memory candidates
 */
export const rejectMemory = <ThrowOnError extends boolean = false>(options: Options<RejectMemoryData, ThrowOnError>) => (options.client ?? client).post<RejectMemoryResponses, RejectMemoryErrors, ThrowOnError>({
 ...
 * `memory:update`: Update or archive durable memory items
 */
export const archiveMemory = <ThrowOnError extends boolean = false>(options: Options<ArchiveMemoryData, ThrowOnError>) => (options.client ?? client).post<ArchiveMemoryResponses, ArchiveMemoryErrors, ThrowOnError>({ url: '/api/memory/{id}/archive', ...options });

/**
 * Restore an archived memory item to candidate status
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `memory:update`: Update or archive durable memory items
 */
export const unarchiveMemory = <ThrowOnError extends boolean = false>(options: Options<UnarchiveMemoryData, ThrowOnError>) => (options.client ?? client).post<UnarchiveMemoryResponses, UnarchiveMemoryErrors, ThrowOnError>({ url: '/api/memory/{id}/unarchive', ...options });
...
/**
 * Update durable memory settings
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * Authorization:
 *
 * `memorySettings:update`: Modify memory settings (extraction, injection, retention, limits)
 */
export const updateMemorySettings = <ThrowOnError extends boolean = false>(options: Options<UpdateMemorySettingsData, ThrowOnError>) => (options.client ?? client).patch<UpdateMemorySettingsResponses, UpdateMemorySettingsErrors, ThrowOnError>({
 ...
 * Authorization:
 *
 * `memorySettings:read`: View memory settings (extraction, injection, retention, limits)
 */
export const getMemoryExtractionStats = <ThrowOnError extends boolean = false>(options?: Options<GetMemoryExtractionStatsData, ThrowOnError>) => (options?.client ?? client).get<GetMemoryExtractionStatsResponses, GetMemoryExtractionStatsErrors, ThrowOnError>({ url: '/api/organization/memory-extraction-stats', ...options });
