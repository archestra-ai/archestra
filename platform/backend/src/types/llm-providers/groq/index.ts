 ...
 *
 * Groq is an OpenAI-compatible inference server.
 * See: https://docs.groq.ai/en/latest/features/openai_api.html
 *
 * NOTE: Groq types are very similar to OpenAI since Groq implements the OpenAI API.
 * The main differences are:
 * - Groq doesn't require API keys (often uses dummy values)
 * - Groq may have additional model-specific fields like "reasoning"
 * - Groq has additional parameters like repetition_penalty
 */
