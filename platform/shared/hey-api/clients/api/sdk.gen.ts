 ...
 * `llmVirtualKey:create`: Create LLM virtual keys
 */
export const createProviderVirtualApiKey = <ThrowOnError extends boolean = false>(options: Options<CreateProviderVirtualApiKeyData, ThrowOnError>) => (options.client ?? client).post<CreateProviderVirtualApiKeyResponses, CreateProviderVirtualApiKeyErrors, ThrowOnError>({
 ...
 * `llmVirtualKey:delete`: Delete LLM virtual keys
 */
export const deleteProviderVirtualApiKey = <ThrowOnError extends boolean = false>(options: Options<DeleteProviderVirtualApiKeyData, ThrowOnError>) => (options.client ?? client).delete<DeleteProviderVirtualApiKeyResponses, DeleteProviderVirtualApiKeyErrors, ThrowOnError>({ url: '/api/llm-provider-api-keys/{chatApiKeyId}/virtual-keys/{id}', ...options });
 ...
 * `llmVirtualKey:update`: Modify LLM virtual keys and their visibility
 */
export const updateProviderVirtualApiKey = <ThrowOnError extends boolean = false>(options: Options<UpdateProviderVirtualApiKeyData, ThrowOnError>) => (options.client ?? client).patch<UpdateProviderVirtualApiKeyResponses, UpdateProviderVirtualApiKeyErrors, ThrowOnError>({
