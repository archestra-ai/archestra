...
- `archestra.authSecret.extraData` - Additional key/value pairs to add to the Helm-managed `<release>-auth` Secret, useful when mounting extra secret-backed files via `archestra.extraVolumes`
