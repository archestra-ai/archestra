...
/**
 * List Kubernetes clusters registered for the organization
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const listK8sClusters = <ThrowOnError extends boolean = false>(options?: Options<ListK8sClustersData, ThrowOnError>) => (options?.client ?? client).get<ListK8sClustersResponses, ListK8sClustersErrors, ThrowOnError>({ url: '/api/k8s/clusters', ...options });
 ...
 */
export const createK8sCluster = <ThrowOnError extends boolean = false>(options: Options<CreateK8sClusterData, ThrowOnError>) => (options.client ?? client).post<CreateK8sClusterResponses, CreateK8sClusterErrors, ThrowOnError>({
...
/**
 * Delete a custom Kubernetes cluster
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `mcpServerInstallation:admin`: Approve or manage all MCP server installations
 */
export const deleteK8sCluster = <ThrowOnError extends boolean = false>(options: Options<DeleteK8sClusterData, ThrowOnError>) => (options.client ?? client).delete<DeleteK8sClusterResponses, DeleteK8sClusterErrors, ThrowOnError>({ url: '/api/k8s/clusters/{id}', ...options });

/**
 * Update a custom Kubernetes cluster
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `mcpServerInstallation:admin`: Approve or manage all MCP server installations
 */
export const updateK8sCluster = <ThrowOnError extends boolean = false>(options: Options<UpdateK8sClusterData, ThrowOnError>) => (options.client ?? client).put<UpdateK8sClusterResponses, UpdateK8sClusterErrors, ThrowOnError>({
...
/**
 * List Kubernetes namespaces for a cluster
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `mcpServerInstallation:read`: View installed MCP servers and their status
 */
export const listK8sNamespaces = <ThrowOnError extends boolean = false>(options?: Options<ListK8sNamespacesData, ThrowOnError>) => (options?.client ?? client).get<ListK8sNamespacesResponses, ListK8sNamespacesErrors, ThrowOnError>({ url: '/api/k8s/namespaces', ...options });
