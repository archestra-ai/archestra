  ...
  implements LLMRequestAdapter<OpenAiRequest, OpenAiMessages>
{
  ...
  // ---------------------------------------------------------------------------
  // Private Helpers (copied from utils/adapters/cerebras.ts)
  // ---------------------------------------------------------------------------
...
// =============================================================================
// TOON COMPRESSION (copied from utils/adapters/cerebras.ts)
// =============================================================================
...
> = {
  ...
  extractErrorMessage(error: unknown): string {
    ...
    const cerebrasMessage = get(error, "error.message");
    if (typeof cerebrasMessage === "string") {
      return cerebrasMessage;
    }
