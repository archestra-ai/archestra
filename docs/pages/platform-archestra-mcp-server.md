...
| Tool | Description | Required RBAC Permission |
|------|-------------|--------------------------|
| `create_bundle` | Create an organization bundle containing skills, plugins, and an optional MCP gateway. | `bundle:create` |
| `get_bundle` | Get one bundle by ID. | `bundle:read` |
| `list_bundles` | List bundles in the active organization. | `bundle:read` |
| `edit_bundle` | Update a bundle. | `bundle:update` |
| `delete_bundle` | Delete a bundle and revoke its linked marketplace installations. | `bundle:delete` |

#### create_bundle

Required RBAC permission: `bundle:create`
...
| `mcp_gateway_id` | `string \| null` | No |  |
| `skill_ids` | `string[]` | No |  |
| `plugin_ids` | `string[]` | No |  |
| `local_mcp_servers` | `object[]` | No |  |
| `local_mcp_servers[].name` | `string` | Yes |  |
| `local_mcp_servers[].description` | `string` | No |  |
| `local_mcp_servers[].command` | `string` | Yes |  |
| `local_mcp_servers[].args` | `string[]` | No |  |
| `local_mcp_servers[].envVarNames` | `string[]` | No |  |
| `local_mcp_servers[].optional` | `boolean` | No |  |
...
|-------|------|----------|-------------|
| `bundle` | `object` | Yes |  |
| `bundle.id` | `string` | Yes |  |
| `bundle.organizationId` | `string` | Yes |  |
| `bundle.name` | `string` | Yes |  |
| `bundle.description` | `string` | Yes |  |
| `bundle.mcpGatewayId` | `string \| null` | Yes |  |
| `bundle.skillIds` | `string[]` | Yes |  |
| `bundle.pluginIds` | `string[]` | Yes |  |
| `bundle.localMcpServers` | `object[]` | Yes |  |
| `bundle.localMcpServers[].id` | `string` | Yes |  |
| `bundle.localMcpServers[].name` | `string` | Yes |  |
| `bundle.localMcpServers[].description` | `string` | Yes |  |
| `bundle.localMcpServers[].command` | `string` | Yes |  |
| `bundle.localMcpServers[].args` | `string[]` | Yes |  |
| `bundle.localMcpServers[].envVarNames` | `string[]` | Yes |  |
| `bundle.localMcpServers[].optional` | `boolean` | Yes |  |
| `bundle.createdAt` | `string` | Yes |  |
| `bundle.updatedAt` | `string` | Yes |  |

#### get_bundle

Required RBAC permission: `bundle:read`
...
|-------|------|----------|-------------|
| `bundles` | `object[]` | Yes |  |
| `bundles[].id` | `string` | Yes |  |
| `bundles[].organizationId` | `string` | Yes |  |
| `bundles[].name` | `string` | Yes |  |
| `bundles[].description` | `string` | Yes |  |
| `bundles[].mcpGatewayId` | `string \| null` | Yes |  |
| `bundles[].skillIds` | `string[]` | Yes |  |
| `bundles[].pluginIds` | `string[]` | Yes |  |
| `bundles[].localMcpServers` | `object[]` | Yes |  |
| `bundles[].localMcpServers[].id` | `string` | Yes |  |
| `bundles[].localMcpServers[].name` | `string` | Yes |  |
| `bundles[].localMcpServers[].description` | `string` | Yes |  |
| `bundles[].localMcpServers[].command` | `string` | Yes |  |
| `bundles[].localMcpServers[].args` | `string[]` | Yes |  |
| `bundles[].localMcpServers[].envVarNames` | `string[]` | Yes |  |
| `bundles[].localMcpServers[].optional` | `boolean` | Yes |  |
| `bundles[].createdAt` | `string` | Yes |  |
| `bundles[].updatedAt` | `string` | Yes |  |

#### edit_bundle

Required RBAC permission: `bundle:update`
...
| `plugin_ids` | `string[]` | No |  |
| `local_mcp_servers` | `object[]` | No |  |
| `local_mcp_servers[].id` | `string` | No |  |
| `local_mcp_servers[].name` | `string` | Yes |  |
| `local_mcp_servers[].description` | `string` | No |  |
| `local_mcp_servers[].command` | `string` | Yes |  |
| `local_mcp_servers[].args` | `string[]` | No |  |
...
Required RBAC permission: `bundle:delete`
