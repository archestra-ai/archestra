 ...
 */
export const updateModelPricing = <ThrowOnError extends boolean = false>(options: Options<UpdateModelPricingData, ThrowOnError>) => (options.client ?? client).patch<UpdateModelPricingResponses, UpdateModelPricingErrors, ThrowOnError>({
 ...
 */
export const getKnowledgeGraphs = <ThrowOnError extends boolean = false>(options?: Options<GetKnowledgeGraphsData, ThrowOnError>) => (options?.client ?? client).get<GetKnowledgeGraphsResponses, GetKnowledgeGraphsErrors, ThrowOnError>({ url: '/api/knowledge-graphs', ...options });

/**
 * Create a new knowledge graph
 */
export const createKnowledgeGraph = <ThrowOnError extends boolean = false>(options: Options<CreateKnowledgeGraphData, ThrowOnError>) => (options.client ?? client).post<CreateKnowledgeGraphResponses, CreateKnowledgeGraphErrors, ThrowOnError>({
...
/**
 * Delete a knowledge graph and all its connectors
 */
export const deleteKnowledgeGraph = <ThrowOnError extends boolean = false>(options: Options<DeleteKnowledgeGraphData, ThrowOnError>) => (options.client ?? client).delete<DeleteKnowledgeGraphResponses, DeleteKnowledgeGraphErrors, ThrowOnError>({ url: '/api/knowledge-graphs/{id}', ...options });

/**
 * Get a knowledge graph by ID
 */
export const getKnowledgeGraph = <ThrowOnError extends boolean = false>(options: Options<GetKnowledgeGraphData, ThrowOnError>) => (options.client ?? client).get<GetKnowledgeGraphResponses, GetKnowledgeGraphErrors, ThrowOnError>({ url: '/api/knowledge-graphs/{id}', ...options });

/**
 * Update a knowledge graph
 */
export const updateKnowledgeGraph = <ThrowOnError extends boolean = false>(options: Options<UpdateKnowledgeGraphData, ThrowOnError>) => (options.client ?? client).put<UpdateKnowledgeGraphResponses, UpdateKnowledgeGraphErrors, ThrowOnError>({
...
/**
 * Check the health of a knowledge graph
 */
export const getKnowledgeGraphHealth = <ThrowOnError extends boolean = false>(options: Options<GetKnowledgeGraphHealthData, ThrowOnError>) => (options.client ?? client).get<GetKnowledgeGraphHealthResponses, GetKnowledgeGraphHealthErrors, ThrowOnError>({ url: '/api/knowledge-graphs/{id}/health', ...options });

/**
 * List connectors for a knowledge graph
 */
export const getConnectors = <ThrowOnError extends boolean = false>(options: Options<GetConnectorsData, ThrowOnError>) => (options.client ?? client).get<GetConnectorsResponses, GetConnectorsErrors, ThrowOnError>({ url: '/api/knowledge-graphs/{kgId}/connectors', ...options });

/**
 * Create a new connector for a knowledge graph
 */
 ...
 * Delete a connector
 */
export const deleteConnector = <ThrowOnError extends boolean = false>(options: Options<DeleteConnectorData, ThrowOnError>) => (options.client ?? client).delete<DeleteConnectorResponses, DeleteConnectorErrors, ThrowOnError>({ url: '/api/knowledge-graphs/{kgId}/connectors/{id}', ...options });

/**
 * Get a connector by ID
 */
export const getConnector = <ThrowOnError extends boolean = false>(options: Options<GetConnectorData, ThrowOnError>) => (options.client ?? client).get<GetConnectorResponses, GetConnectorErrors, ThrowOnError>({ url: '/api/knowledge-graphs/{kgId}/connectors/{id}', ...options });
 ...
 */
export const syncConnector = <ThrowOnError extends boolean = false>(options: Options<SyncConnectorData, ThrowOnError>) => (options.client ?? client).post<SyncConnectorResponses, SyncConnectorErrors, ThrowOnError>({ url: '/api/knowledge-graphs/{kgId}/connectors/{id}/sync', ...options });

/**
 * Test a connector connection
 */
export const testConnectorConnection = <ThrowOnError extends boolean = false>(options: Options<TestConnectorConnectionData, ThrowOnError>) => (options.client ?? client).post<TestConnectorConnectionResponses, TestConnectorConnectionErrors, ThrowOnError>({ url: '/api/knowledge-graphs/{kgId}/connectors/{id}/test', ...options });

/**
 * List connector runs
 */
export const getConnectorRuns = <ThrowOnError extends boolean = false>(options: Options<GetConnectorRunsData, ThrowOnError>) => (options.client ?? client).get<GetConnectorRunsResponses, GetConnectorRunsErrors, ThrowOnError>({ url: '/api/knowledge-graphs/{kgId}/connectors/{id}/runs', ...options });

/**
 * Internal endpoint called by K8s CronJobs to trigger sync
 */
export const postApiInternalConnectorsByConnectorIdSync = <ThrowOnError extends boolean = false>(options: Options<PostApiInternalConnectorsByConnectorIdSyncData, ThrowOnError>) => (options.client ?? client).post<PostApiInternalConnectorsByConnectorIdSyncResponses, PostApiInternalConnectorsByConnectorIdSyncErrors, ThrowOnError>({ url: '/api/internal/connectors/{connectorId}/sync', ...options });
