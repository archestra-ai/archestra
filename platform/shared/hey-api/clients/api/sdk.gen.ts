 ...
 * `llmCost:read`: View LLM usage cost statistics and analytics
 */
export const getVirtualKeyStatistics = <ThrowOnError extends boolean = false>(options?: Options<GetVirtualKeyStatisticsData, ThrowOnError>) => (options?.client ?? client).get<GetVirtualKeyStatisticsResponses, GetVirtualKeyStatisticsErrors, ThrowOnError>({ url: '/api/statistics/virtual-keys', ...options });
