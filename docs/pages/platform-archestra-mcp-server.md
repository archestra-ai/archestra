...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `tasks` | `object[]` | Yes | This conversation's background tasks, newest first. |
| `tasks[].taskId` | `string` | Yes | The task's id (usable with cancel_background_task). |
| `tasks[].status` | `"working" \| "completed" \| "failed" \| "cancelled"` | Yes | Current task status. |
| `tasks[].kind` | `"delegation" \| "skill"` | Yes | What spawned the task: an agent delegation or a skill run. |
| `tasks[].agentName` | `string` | Yes | The subagent the task runs on. |
| `tasks[].toolName` | `string` | Yes | The delegation tool that spawned the task. |
| `tasks[].startedAt` | `string` | Yes | When the task started (ISO timestamp). |
| `tasks[].settledAt` | `string \| null` | Yes | When the task settled, or null while still working. |
...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `taskId` | `string` | Yes | Id of the background task to cancel. |
