...
export type GetChatApiKeysResponses = {
    ...
    200: Array<{
        ...
        organizationId: string;
        name: string;
        provider: 'anthropic' | 'bedrock' | 'cerebras' | 'groq' | 'cohere' | 'gemini' | 'mistral' | 'openai' | 'vllm' | 'ollama' | 'zhipuai';
...
export type GetChatConversationsResponses = {
    ...
    200: Array<{
        ...
        selectedProvider: 'anthropic' | 'bedrock' | 'cerebras' | 'groq' | 'cohere' | 'gemini' | 'mistral' | 'openai' | 'vllm' | 'ollama' | 'zhipuai';
