...
/** Internal-only. Trusted by the LLM proxy only when the request originates from a loopback address. */
export const BILLED_USER_ID_HEADER = "X-Archestra-Billed-User-Id";
