 ...
 * This route accepts either an LLM provider API key or a Virtual API Key. See [LLM Proxy Authentication](/docs/platform-llm-proxy-authentication).
 */
export const orcarouterChatCompletionsWithDefaultAgent = <ThrowOnError extends boolean = false>(options: Options<OrcarouterChatCompletionsWithDefaultAgentData, ThrowOnError>) => (options.client ?? client).post<OrcarouterChatCompletionsWithDefaultAgentResponses, OrcarouterChatCompletionsWithDefaultAgentErrors, ThrowOnError>({
    url: '/v1/orcarouter/chat/completions',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * This route accepts either an LLM provider API key or a Virtual API Key. See [LLM Proxy Authentication](/docs/platform-llm-proxy-authentication).
 */
export const orcarouterChatCompletionsWithAgent = <ThrowOnError extends boolean = false>(options: Options<OrcarouterChatCompletionsWithAgentData, ThrowOnError>) => (options.client ?? client).post<OrcarouterChatCompletionsWithAgentResponses, OrcarouterChatCompletionsWithAgentErrors, ThrowOnError>({
    url: '/v1/orcarouter/{agentId}/chat/completions',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
