    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          size="sm"
          onClick={() =>
            // biome-ignore lint/suspicious/noExplicitAny: Type-safe append requires any due to generic constraints
            append({ key: "", type: "plain_text", value: "" } as any)
          }
        >
