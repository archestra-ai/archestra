 ...
 * `environment:read`: View deployment environments
 */
export const validateEnvironmentNamespace = <ThrowOnError extends boolean = false>(options: Options<ValidateEnvironmentNamespaceData, ThrowOnError>) => (options.client ?? client).get<ValidateEnvironmentNamespaceResponses, ValidateEnvironmentNamespaceErrors, ThrowOnError>({ url: '/api/organization/environments/validate-namespace', ...options });
