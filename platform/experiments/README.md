...
--model <model>           The model to use (default: gpt-4o for openai, gemini-pro-2.5 for gemini)
...
pnpm cli-chat-with-guardrails --provider gemini --model gemini-pro-2.5 --stream
```
