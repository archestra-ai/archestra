...
/**
 * Generic adapter incoming message webhook
 */
export const postApiWebhooksChatopsGenericByAdapterIdMessages = <ThrowOnError extends boolean = false>(options: Options<PostApiWebhooksChatopsGenericByAdapterIdMessagesData, ThrowOnError>) => (options.client ?? client).post<PostApiWebhooksChatopsGenericByAdapterIdMessagesResponses, PostApiWebhooksChatopsGenericByAdapterIdMessagesErrors, ThrowOnError>({
...
/**
 * Generic adapter interactive event webhook
 */
export const postApiWebhooksChatopsGenericByAdapterIdInteractive = <ThrowOnError extends boolean = false>(options: Options<PostApiWebhooksChatopsGenericByAdapterIdInteractiveData, ThrowOnError>) => (options.client ?? client).post<PostApiWebhooksChatopsGenericByAdapterIdInteractiveResponses, PostApiWebhooksChatopsGenericByAdapterIdInteractiveErrors, ThrowOnError>({
...
/**
 * Generic adapter channel sync webhook
 */
export const postApiWebhooksChatopsGenericByAdapterIdChannelsSync = <ThrowOnError extends boolean = false>(options: Options<PostApiWebhooksChatopsGenericByAdapterIdChannelsSyncData, ThrowOnError>) => (options.client ?? client).post<PostApiWebhooksChatopsGenericByAdapterIdChannelsSyncResponses, PostApiWebhooksChatopsGenericByAdapterIdChannelsSyncErrors, ThrowOnError>({
...
/**
 * List bundled ChatOps adapters and their runtime state
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `agentTrigger:read`: View agent trigger configurations (Slack, MS Teams, email)
 */
export const listBundledChatOpsAdapters = <ThrowOnError extends boolean = false>(options?: Options<ListBundledChatOpsAdaptersData, ThrowOnError>) => (options?.client ?? client).get<ListBundledChatOpsAdaptersResponses, ListBundledChatOpsAdaptersErrors, ThrowOnError>({ url: '/api/chatops/generic/builtin-adapters', ...options });

/**
 * Start a bundled ChatOps adapter process
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const startBundledChatOpsAdapter = <ThrowOnError extends boolean = false>(options: Options<StartBundledChatOpsAdapterData, ThrowOnError>) => (options.client ?? client).post<StartBundledChatOpsAdapterResponses, StartBundledChatOpsAdapterErrors, ThrowOnError>({ url: '/api/chatops/generic/builtin-adapters/{adapterId}/start', ...options });

/**
 * Stop a bundled ChatOps adapter process
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `agentTrigger:update`: Modify agent trigger configurations
 */
export const stopBundledChatOpsAdapter = <ThrowOnError extends boolean = false>(options: Options<StopBundledChatOpsAdapterData, ThrowOnError>) => (options.client ?? client).post<StopBundledChatOpsAdapterResponses, StopBundledChatOpsAdapterErrors, ThrowOnError>({ url: '/api/chatops/generic/builtin-adapters/{adapterId}/stop', ...options });

/**
 * Proxy connection page from a bundled ChatOps adapter
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `agentTrigger:read`: View agent trigger configurations (Slack, MS Teams, email)
 */
export const getBundledChatOpsAdapterConnectionPage = <ThrowOnError extends boolean = false>(options: Options<GetBundledChatOpsAdapterConnectionPageData, ThrowOnError>) => (options.client ?? client).get<GetBundledChatOpsAdapterConnectionPageResponses, unknown, ThrowOnError>({ url: '/api/chatops/generic/builtin-adapters/{adapterId}/connection-page', ...options });
 ...
 * `agentTrigger:update`: Modify agent trigger configurations
 */
export const unlinkBundledChatOpsAdapter = <ThrowOnError extends boolean = false>(options: Options<UnlinkBundledChatOpsAdapterData, ThrowOnError>) => (options.client ?? client).post<UnlinkBundledChatOpsAdapterResponses, unknown, ThrowOnError>({ url: '/api/chatops/generic/builtin-adapters/{adapterId}/connection-page/unlink', ...options });
