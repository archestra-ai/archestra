...
Chat attachments are scoped to their conversation. Users with Knowledge File upload permission can save a sent attachment to **Knowledge > Files**, choose visibility, and select the agents or MCP Gateways that can retrieve it later.
