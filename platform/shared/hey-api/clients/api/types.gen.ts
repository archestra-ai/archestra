...
export type XaiChatCompletionResponseInput = {
    ...
    choices: Array<{
        ...
        logprobs: unknown;
        /**
         * x.ai message format - OpenAI-compatible
         */
        message: {
            content?: string | unknown;
            refusal?: string | unknown;
...
export type GetChatApiKeysResponses = {
    ...
    200: Array<{
        ...
        name: string;
        provider: 'anthropic' | 'cerebras' | 'gemini' | 'openai' | 'vllm' | 'ollama' | 'xai' | 'zhipuai';
...
export type CreateChatConversationData = {
    body: {
        ...
        title?: string | null;
        selectedModel?: string;
        selectedProvider?: 'anthropic' | 'cerebras' | 'gemini' | 'openai' | 'vllm' | 'ollama' | 'xai' | 'zhipuai';
        chatApiKeyId?: string | null;
    };
    path?: never;
    query?: never;
...
export type GetOptimizationRulesResponses = {
    ...
    200: Array<{
        ...
        provider: 'openai' | 'gemini' | 'anthropic' | 'cerebras' | 'vllm' | 'ollama' | 'xai' | 'zhipuai';
        targetModel: string;
        enabled: boolean;
        createdAt: string;
        updatedAt: string;
