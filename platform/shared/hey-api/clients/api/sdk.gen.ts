 ...
 */
export const getAgentTemplates = <ThrowOnError extends boolean = false>(options?: Options<GetAgentTemplatesData, ThrowOnError>) => (options?.client ?? client).get<GetAgentTemplatesResponses, GetAgentTemplatesErrors, ThrowOnError>({ url: '/api/agent_templates', ...options });
 ...
 * `agent:create`: Create new agents
 */
export const getAgentTemplateRequirements = <ThrowOnError extends boolean = false>(options: Options<GetAgentTemplateRequirementsData, ThrowOnError>) => (options.client ?? client).get<GetAgentTemplateRequirementsResponses, GetAgentTemplateRequirementsErrors, ThrowOnError>({ url: '/api/agent_templates/{id}/requirements', ...options });
