...
describe("client trajectory identity", () => {
  ...
  describe("Codex", () => {
    ...
    test("accepts matching flat and nested turn metadata", () => {
      expect(
        extractAppaSessionIdentity({
          family: "openai:responses",
          body: {
  ...
  describe("OpenCode", () => {
    ...
    test("uses x-session-affinity only after OpenCode is identified", () => {
      expect(
        extractAppaSessionIdentity({
          family: "openai:chatCompletions",
          body: {},
    ...
    test.for([
      ...
      "x-session-affinity",
      "session-id",
    ])("a bare %s is never attributed without OpenCode evidence", (header) => {
      const identity = extractAppaSessionIdentity({
        family: "openai:chatCompletions",
        body: {},
        headers: { [header]: OPENCODE_SESSION },
      });
