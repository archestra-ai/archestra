export const RouteId = {
  ...
  GetEvalSuites: "getEvalSuites",
  CreateEvalSuite: "createEvalSuite",
  GetEvalSuite: "getEvalSuite",
  UpdateEvalSuite: "updateEvalSuite",
  DeleteEvalSuite: "deleteEvalSuite",
  GetEvalSuiteCases: "getEvalSuiteCases",
  CreateEvalSuiteCase: "createEvalSuiteCase",
  UpdateEvalCase: "updateEvalCase",
  DeleteEvalCase: "deleteEvalCase",
  CreateEvalRun: "createEvalRun",
  GetEvalRuns: "getEvalRuns",
