...
(() => {
   ...
   *   can render a "Connect" button that calls archestra.ui.openLink(url) —
   *   the sandbox blocks popups, so a plain target="_blank" link cannot open
   *   (the user authenticates in the registry UI);
