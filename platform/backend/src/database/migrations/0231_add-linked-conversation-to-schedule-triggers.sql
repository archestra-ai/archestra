...
CREATE INDEX "schedule_triggers_linked_conversation_id_idx" ON "schedule_triggers" USING btree ("linked_conversation_id");--> statement-breakpoint
...
ADD COLUMN "reply_channel" text DEFAULT 'chat' NOT NULL;
