 ...
 */
export const getChatGlobalTools = <ThrowOnError extends boolean = false>(options?: Options<GetChatGlobalToolsData, ThrowOnError>) => (options?.client ?? client).get<GetChatGlobalToolsResponses, GetChatGlobalToolsErrors, ThrowOnError>({ url: '/api/chat/global-tools', ...options });
