...
/**
 * Boolean query-string flag: accepts exactly "true"/"false" (or an actual
 * boolean) and rejects anything else with a validation error. Never use
 * `z.coerce.boolean()` for query params — it coerces every non-empty string,
