...
/**
 * List the chat-scoped files a rendered app may read — the backing of the SDK's archestra.files.list.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `app:read`: View and run MCP Apps within your scope (org, your teams, your own)
 */
export const getAppConversationFiles = <ThrowOnError extends boolean = false>(options: Options<GetAppConversationFilesData, ThrowOnError>) => (options.client ?? client).get<GetAppConversationFilesResponses, GetAppConversationFilesErrors, ThrowOnError>({ url: '/api/apps/{appId}/files', ...options });

/**
 * Stream the raw bytes of a chat-scoped file to a rendered app — the backing of the SDK's archestra.files.read. Identify the file by id (or obj_ ref) or by filename.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `app:read`: View and run MCP Apps within your scope (org, your teams, your own)
 */
export const getAppConversationFileRaw = <ThrowOnError extends boolean = false>(options: Options<GetAppConversationFileRawData, ThrowOnError>) => (options.client ?? client).get<GetAppConversationFileRawResponses, unknown, ThrowOnError>({ url: '/api/apps/{appId}/files/raw', ...options });
