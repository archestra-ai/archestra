...
| `items[].serverType` | `"local" \| "remote" \| "builtin" \| "app"` | Yes | Whether the server is local, remote, or builtin. |
...
|-----------|------|----------|-------------|
| `id` | `string` | Yes | The catalog ID of the MCP server to edit. Use get_mcp_servers to look it up by name. |
| `serverType` | `"local" \| "remote" \| "builtin" \| "app"` | No | Server type: local, remote, or builtin. |
