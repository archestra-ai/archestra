...
export const bedrockProxyRoutes = config.llm.bedrock.useV2Routes
  ? bedrockProxyRoutesV2
  : bedrockProxyRoutesV2; // Bedrock only has V2 since it was added after the unified handler
