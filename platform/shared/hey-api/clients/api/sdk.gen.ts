...
/**
 * List runners in the organization
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const getAllRunners = <ThrowOnError extends boolean = false>(options?: Options<GetAllRunnersData, ThrowOnError>) => (options?.client ?? client).get<GetAllRunnersResponses, GetAllRunnersErrors, ThrowOnError>({ url: '/api/runners', ...options });
...
/**
 * Delete a runner and its session history
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const deleteRunner = <ThrowOnError extends boolean = false>(options: Options<DeleteRunnerData, ThrowOnError>) => (options.client ?? client).delete<DeleteRunnerResponses, DeleteRunnerErrors, ThrowOnError>({ url: '/api/runners/{id}', ...options });
 ...
 * `runner:read`: View and list runners and their session timelines
 */
export const getRunner = <ThrowOnError extends boolean = false>(options: Options<GetRunnerData, ThrowOnError>) => (options.client ?? client).get<GetRunnerResponses, GetRunnerErrors, ThrowOnError>({ url: '/api/runners/{id}', ...options });

/**
 * Get a runner's session timeline
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `runner:read`: View and list runners and their session timelines
 */
export const getRunnerEvents = <ThrowOnError extends boolean = false>(options: Options<GetRunnerEventsData, ThrowOnError>) => (options.client ?? client).get<GetRunnerEventsResponses, GetRunnerEventsErrors, ThrowOnError>({ url: '/api/runners/{id}/events', ...options });
 ...
 * `runner:read`: View and list runners and their session timelines
 */
export const getRunnerPreflight = <ThrowOnError extends boolean = false>(options: Options<GetRunnerPreflightData, ThrowOnError>) => (options.client ?? client).get<GetRunnerPreflightResponses, GetRunnerPreflightErrors, ThrowOnError>({ url: '/api/runners/preflight', ...options });
 ...
 */
export const steerRunner = <ThrowOnError extends boolean = false>(options: Options<SteerRunnerData, ThrowOnError>) => (options.client ?? client).post<SteerRunnerResponses, SteerRunnerErrors, ThrowOnError>({
 ...
 * `runner:update`: Steer and stop runners you started
 */
export const stopRunner = <ThrowOnError extends boolean = false>(options: Options<StopRunnerData, ThrowOnError>) => (options.client ?? client).post<StopRunnerResponses, StopRunnerErrors, ThrowOnError>({ url: '/api/runners/{id}/stop', ...options });
...
/**
 * List the credentials the current user has supplied
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * None (no additional RBAC permission required)
 */
export const getAllUserCredentials = <ThrowOnError extends boolean = false>(options?: Options<GetAllUserCredentialsData, ThrowOnError>) => (options?.client ?? client).get<GetAllUserCredentialsResponses, GetAllUserCredentialsErrors, ThrowOnError>({ url: '/api/account/credentials', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const deleteUserCredential = <ThrowOnError extends boolean = false>(options: Options<DeleteUserCredentialData, ThrowOnError>) => (options.client ?? client).delete<DeleteUserCredentialResponses, DeleteUserCredentialErrors, ThrowOnError>({ url: '/api/account/credentials/{key}', ...options });

/**
 * Store or replace one of the current user's credentials
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * None (no additional RBAC permission required)
 */
export const upsertUserCredential = <ThrowOnError extends boolean = false>(options: Options<UpsertUserCredentialData, ThrowOnError>) => (options.client ?? client).put<UpsertUserCredentialResponses, UpsertUserCredentialErrors, ThrowOnError>({
