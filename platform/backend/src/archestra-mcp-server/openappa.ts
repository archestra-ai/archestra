...
const registry = defineArchestraTools([
  ...
  defineArchestraTool({
    ...
    description:
      "Read why the guardrails policy blocked a tool call and which remedy plans are offered. The platform delivers this call in place of a blocked call. It runs nothing and changes nothing. The ruling argument explains why the call was blocked. The plans are addressed to you. When the ruling offers a plan, name it to the user, choose it, call execute_remedy_plan with the offer_id and plan shown in the ruling, then retry the original call. If no plan is offered, explain the block. If you need the user's decision, use ask_user instead of a free-form question.",
