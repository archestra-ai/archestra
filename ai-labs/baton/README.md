...
trajectory turn, a per-dimension algebra folds them into a context label,
tool contracts are checked as `requirements − context`, violations escalate
to an authority, every loosening is an audited declassification, and
