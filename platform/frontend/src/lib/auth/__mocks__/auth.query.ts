...
export const useHasPagePermissions = useHasPermissions;
const emptyCapabilities = { data: [], isPending: false, isLoading: false };
export const useScopedCapabilities = vi.fn(() => emptyCapabilities);
