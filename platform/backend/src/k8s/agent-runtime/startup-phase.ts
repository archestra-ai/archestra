...
export type AgentRuntimeStartupProgress = {
 ...
 */
export function describeAgentRuntimeStartupProgress(
  pod: k8s.V1Pod | null,
): AgentRuntimeStartupProgress {
  if (!pod) {
    return {
      phase: "queued",
...
export function attachingProgress(): AgentRuntimeStartupProgress {
  return {
    phase: "attaching",
 ...
 */
export function isSameAgentRuntimeStartupProgress(
  a: AgentRuntimeStartupProgress | null,
  b: AgentRuntimeStartupProgress,
): boolean {
  return (
    a !== null &&
    a.phase === b.phase &&
...
export type AgentRuntimeStartupProgressReporter = (
  progress: AgentRuntimeStartupProgress & { resourceName?: string | null },
) => void;
