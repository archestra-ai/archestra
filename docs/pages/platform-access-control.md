...
| `knowledgeBase:create` | Create new knowledge graphs for rag-based document retrieval |
| `knowledgeBase:read` | View and list knowledge graphs for rag-based document retrieval |
| `knowledgeBase:update` | Modify existing knowledge graphs for rag-based document retrieval |
| `knowledgeBase:delete` | Remove existing knowledge graphs for rag-based document retrieval |
