...
// Advisor Mode rides the beta switch; turn it on so its tool is seeded and
// assigned like any other built-in. Suites exercising the gate itself flip
// config.advisor.enabled at runtime.
