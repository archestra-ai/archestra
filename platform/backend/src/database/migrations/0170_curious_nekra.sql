...
ALTER TABLE "organization" DROP COLUMN "embedding_api_key_secret_id";--> statement-breakpoint
ALTER TABLE "organization" ALTER COLUMN "embedding_model" DROP DEFAULT;