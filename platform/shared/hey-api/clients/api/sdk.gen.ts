 ...
 */
export const getProfileTokenValue = <ThrowOnError extends boolean = false>(options: Options<GetProfileTokenValueData, ThrowOnError>) => (options.client ?? client).get<GetProfileTokenValueResponses, GetProfileTokenValueErrors, ThrowOnError>({ url: '/api/profiles/{profileId}/tokens/{tokenId}/value', ...options });
