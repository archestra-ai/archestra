...
See [Environments](/docs/platform-environments) for the isolation model and [Network Egress Policies](/docs/platform-private-registry#network-egress-policies) for how policies are configured.
