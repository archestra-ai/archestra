...
export const TOOL_DRAFT_SKILL_FROM_AGENT_SHORT_NAME = "draft_skill_from_agent";
...
export const TOOL_DRAFT_SKILL_FROM_AGENT_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_DRAFT_SKILL_FROM_AGENT_SHORT_NAME}` as const;
