 ...
 */
export const getApiPromptsByPromptIdEmailAddress = <ThrowOnError extends boolean = false>(options: Options<GetApiPromptsByPromptIdEmailAddressData, ThrowOnError>) => (options.client ?? client).get<GetApiPromptsByPromptIdEmailAddressResponses, GetApiPromptsByPromptIdEmailAddressErrors, ThrowOnError>({ url: '/api/prompts/{promptId}/email-address', ...options });
 ...
 */
export const postApiWebhooksIncomingEmailSetup = <ThrowOnError extends boolean = false>(options?: Options<PostApiWebhooksIncomingEmailSetupData, ThrowOnError>) => (options?.client ?? client).post<PostApiWebhooksIncomingEmailSetupResponses, PostApiWebhooksIncomingEmailSetupErrors, ThrowOnError>({
