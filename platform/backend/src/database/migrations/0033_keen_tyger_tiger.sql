...
ALTER TABLE "mcp_server_installation_request" ADD CONSTRAINT "mcp_server_installation_request_catalog_id_internal_mcp_catalog_id_fk" FOREIGN KEY ("catalog_id") REFERENCES "public"."internal_mcp_catalog"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
