 ...
 */
export const getBatchAnalysisTemplates = <ThrowOnError extends boolean = false>(options?: Options<GetBatchAnalysisTemplatesData, ThrowOnError>) => (options?.client ?? client).get<GetBatchAnalysisTemplatesResponses, GetBatchAnalysisTemplatesErrors, ThrowOnError>({ url: '/api/batch-analysis-templates', ...options });

/**
 * List batch analyses in the organization
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `batchAnalysis:read`: View batch analyses and their results
 */
export const getBatchAnalyses = <ThrowOnError extends boolean = false>(options?: Options<GetBatchAnalysesData, ThrowOnError>) => (options?.client ?? client).get<GetBatchAnalysesResponses, GetBatchAnalysesErrors, ThrowOnError>({ url: '/api/batch-analyses', ...options });
 ...
 */
export const createBatchAnalysis = <ThrowOnError extends boolean = false>(options: Options<CreateBatchAnalysisData, ThrowOnError>) => (options.client ?? client).post<CreateBatchAnalysisResponses, CreateBatchAnalysisErrors, ThrowOnError>({
...
/**
 * Delete a batch analysis, its rows, cells and runs
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const deleteBatchAnalysis = <ThrowOnError extends boolean = false>(options: Options<DeleteBatchAnalysisData, ThrowOnError>) => (options.client ?? client).delete<DeleteBatchAnalysisResponses, DeleteBatchAnalysisErrors, ThrowOnError>({ url: '/api/batch-analyses/{analysisId}', ...options });
 ...
 * `batchAnalysis:read`: View batch analyses and their results
 */
export const getBatchAnalysis = <ThrowOnError extends boolean = false>(options: Options<GetBatchAnalysisData, ThrowOnError>) => (options.client ?? client).get<GetBatchAnalysisResponses, GetBatchAnalysisErrors, ThrowOnError>({ url: '/api/batch-analyses/{analysisId}', ...options });

/**
 * Update a batch analysis's configuration
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const updateBatchAnalysis = <ThrowOnError extends boolean = false>(options: Options<UpdateBatchAnalysisData, ThrowOnError>) => (options.client ?? client).patch<UpdateBatchAnalysisResponses, UpdateBatchAnalysisErrors, ThrowOnError>({
...
/**
 * Add rows (inputs) to a batch analysis
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `batchAnalysis:update`: Modify batch analyses and add rows to them
 */
export const addBatchAnalysisRows = <ThrowOnError extends boolean = false>(options: Options<AddBatchAnalysisRowsData, ThrowOnError>) => (options.client ?? client).post<AddBatchAnalysisRowsResponses, AddBatchAnalysisRowsErrors, ThrowOnError>({
 ...
 * `batchAnalysis:update`: Modify batch analyses and add rows to them
 */
export const deleteBatchAnalysisRow = <ThrowOnError extends boolean = false>(options: Options<DeleteBatchAnalysisRowData, ThrowOnError>) => (options.client ?? client).delete<DeleteBatchAnalysisRowResponses, DeleteBatchAnalysisRowErrors, ThrowOnError>({ url: '/api/batch-analyses/{analysisId}/rows/{rowId}', ...options });
 ...
 */
export const startBatchAnalysisRun = <ThrowOnError extends boolean = false>(options: Options<StartBatchAnalysisRunData, ThrowOnError>) => (options.client ?? client).post<StartBatchAnalysisRunResponses, StartBatchAnalysisRunErrors, ThrowOnError>({ url: '/api/batch-analyses/{analysisId}/runs', ...options });

/**
 * Reset a single cell and dispatch just that cell
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `batchAnalysis:execute`: Dispatch a batch analysis run (spends LLM budget per cell)
 */
export const retryBatchAnalysisCell = <ThrowOnError extends boolean = false>(options: Options<RetryBatchAnalysisCellData, ThrowOnError>) => (options.client ?? client).post<RetryBatchAnalysisCellResponses, RetryBatchAnalysisCellErrors, ThrowOnError>({ url: '/api/batch-analyses/{analysisId}/rows/{rowId}/cells/{columnKey}/retry', ...options });
 ...
 */
export const askBatchAnalysis = <ThrowOnError extends boolean = false>(options: Options<AskBatchAnalysisData, ThrowOnError>) => (options.client ?? client).post<AskBatchAnalysisResponses, AskBatchAnalysisErrors, ThrowOnError>({
 ...
 * `batchAnalysis:update`: Modify batch analyses and add rows to them
 */
export const verifyBatchAnalysisCells = <ThrowOnError extends boolean = false>(options: Options<VerifyBatchAnalysisCellsData, ThrowOnError>) => (options.client ?? client).patch<VerifyBatchAnalysisCellsResponses, VerifyBatchAnalysisCellsErrors, ThrowOnError>({
