...
CREATE INDEX "a2a_task_active_heartbeat_idx" ON "a2a_task" USING btree ("last_heartbeat_at") WHERE "a2a_task"."state" IN ('TASK_STATE_SUBMITTED', 'TASK_STATE_WORKING');
--> statement-breakpoint
