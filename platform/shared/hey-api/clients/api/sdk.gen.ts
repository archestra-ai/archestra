 ...
 */
export const getSsoProviderIdpLogoutUrl = <ThrowOnError extends boolean = false>(options?: Options<GetSsoProviderIdpLogoutUrlData, ThrowOnError>) => (options?.client ?? client).get<GetSsoProviderIdpLogoutUrlResponses, GetSsoProviderIdpLogoutUrlErrors, ThrowOnError>({ url: '/api/sso-providers/idp-logout-url', ...options });
