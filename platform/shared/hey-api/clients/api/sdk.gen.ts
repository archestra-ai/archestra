 ...
 * `chat:read`: View and access chat conversations
 */
export const getChatMetaAgent = <ThrowOnError extends boolean = false>(options?: Options<GetChatMetaAgentData, ThrowOnError>) => (options?.client ?? client).get<GetChatMetaAgentResponses, GetChatMetaAgentErrors, ThrowOnError>({ url: '/api/chat/meta-agent', ...options });
