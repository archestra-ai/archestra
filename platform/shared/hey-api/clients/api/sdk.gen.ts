 ...
 * `knowledgeSettings:read`: View knowledge settings (embedding and reranking models)
 */
export const getRetrievalEvaluationCapabilities = <ThrowOnError extends boolean = false>(options?: Options<GetRetrievalEvaluationCapabilitiesData, ThrowOnError>) => (options?.client ?? client).get<GetRetrievalEvaluationCapabilitiesResponses, GetRetrievalEvaluationCapabilitiesErrors, ThrowOnError>({ url: '/api/organization/knowledge-settings/retrieval-evaluations/capabilities', ...options });

/**
 * Preview retrieval-evaluation capabilities with run-only Knowledge settings
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeSettings:read`: View knowledge settings (embedding and reranking models)
 */
export const previewRetrievalEvaluationCapabilities = <ThrowOnError extends boolean = false>(options: Options<PreviewRetrievalEvaluationCapabilitiesData, ThrowOnError>) => (options.client ?? client).post<PreviewRetrievalEvaluationCapabilitiesResponses, PreviewRetrievalEvaluationCapabilitiesErrors, ThrowOnError>({
    url: '/api/organization/knowledge-settings/retrieval-evaluations/capabilities/preview',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * List recent retrieval-evaluation runs
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeSettings:read`: View knowledge settings (embedding and reranking models)
 */
export const listRetrievalEvaluationRuns = <ThrowOnError extends boolean = false>(options?: Options<ListRetrievalEvaluationRunsData, ThrowOnError>) => (options?.client ?? client).get<ListRetrievalEvaluationRunsResponses, ListRetrievalEvaluationRunsErrors, ThrowOnError>({ url: '/api/organization/knowledge-settings/retrieval-evaluations', ...options });
 ...
 * `knowledgeSettings:update`: Modify knowledge settings (embedding and reranking models)
 */
export const startRetrievalEvaluation = <ThrowOnError extends boolean = false>(options: Options<StartRetrievalEvaluationData, ThrowOnError>) => (options.client ?? client).post<StartRetrievalEvaluationResponses, StartRetrievalEvaluationErrors, ThrowOnError>({
...
/**
 * Get one retrieval-evaluation run and its artifact
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeSettings:read`: View knowledge settings (embedding and reranking models)
 */
export const getRetrievalEvaluationRun = <ThrowOnError extends boolean = false>(options: Options<GetRetrievalEvaluationRunData, ThrowOnError>) => (options.client ?? client).get<GetRetrievalEvaluationRunResponses, GetRetrievalEvaluationRunErrors, ThrowOnError>({ url: '/api/organization/knowledge-settings/retrieval-evaluations/{id}', ...options });

/**
 * Request cancellation of a retrieval evaluation
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeSettings:update`: Modify knowledge settings (embedding and reranking models)
 */
export const cancelRetrievalEvaluation = <ThrowOnError extends boolean = false>(options: Options<CancelRetrievalEvaluationData, ThrowOnError>) => (options.client ?? client).post<CancelRetrievalEvaluationResponses, CancelRetrievalEvaluationErrors, ThrowOnError>({ url: '/api/organization/knowledge-settings/retrieval-evaluations/{id}/cancel', ...options });

/**
 * Compare two completed retrieval-evaluation artifacts
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeSettings:read`: View knowledge settings (embedding and reranking models)
 */
export const compareRetrievalEvaluations = <ThrowOnError extends boolean = false>(options: Options<CompareRetrievalEvaluationsData, ThrowOnError>) => (options.client ?? client).get<CompareRetrievalEvaluationsResponses, CompareRetrievalEvaluationsErrors, ThrowOnError>({ url: '/api/organization/knowledge-settings/retrieval-evaluations/{id}/compare/{otherId}', ...options });
