 ...
 * `mcpServerInstallation:admin`: Approve or manage all MCP server installations
 */
export const declineCatalogItemImage = <ThrowOnError extends boolean = false>(options: Options<DeclineCatalogItemImageData, ThrowOnError>) => (options.client ?? client).post<DeclineCatalogItemImageResponses, DeclineCatalogItemImageErrors, ThrowOnError>({
    url: '/api/internal_mcp_catalog/{id}/decline',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
