/**
 * MiniMax Interaction Utils
 *
 * MiniMax exposes an OpenAI-compatible API, so we can reuse the OpenAI interaction class.
 ...
 * This class handles MiniMax chat completion interactions identically to OpenAI.
 */
class MiniMaxChatCompletionInteraction implements InteractionUtils {
  // MiniMax uses OpenAI-compatible types
