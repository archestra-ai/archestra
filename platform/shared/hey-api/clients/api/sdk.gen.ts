...
/**
 * List connectors for a knowledge base
 */
export const getConnectors = <ThrowOnError extends boolean = false>(options: Options<GetConnectorsData, ThrowOnError>) => (options.client ?? client).get<GetConnectorsResponses, GetConnectorsErrors, ThrowOnError>({ url: '/api/knowledge-bases/{kgId}/connectors', ...options });

/**
 * Create a new connector for a knowledge base
 */
 ...
 * Delete a connector
 */
export const deleteConnector = <ThrowOnError extends boolean = false>(options: Options<DeleteConnectorData, ThrowOnError>) => (options.client ?? client).delete<DeleteConnectorResponses, DeleteConnectorErrors, ThrowOnError>({ url: '/api/knowledge-bases/{kgId}/connectors/{id}', ...options });

/**
 * Get a connector by ID
 */
export const getConnector = <ThrowOnError extends boolean = false>(options: Options<GetConnectorData, ThrowOnError>) => (options.client ?? client).get<GetConnectorResponses, GetConnectorErrors, ThrowOnError>({ url: '/api/knowledge-bases/{kgId}/connectors/{id}', ...options });
 ...
 */
export const syncConnector = <ThrowOnError extends boolean = false>(options: Options<SyncConnectorData, ThrowOnError>) => (options.client ?? client).post<SyncConnectorResponses, SyncConnectorErrors, ThrowOnError>({ url: '/api/knowledge-bases/{kgId}/connectors/{id}/sync', ...options });

/**
 * Test a connector connection
 */
export const testConnectorConnection = <ThrowOnError extends boolean = false>(options: Options<TestConnectorConnectionData, ThrowOnError>) => (options.client ?? client).post<TestConnectorConnectionResponses, TestConnectorConnectionErrors, ThrowOnError>({ url: '/api/knowledge-bases/{kgId}/connectors/{id}/test', ...options });

/**
 * List connector runs
 */
export const getConnectorRuns = <ThrowOnError extends boolean = false>(options: Options<GetConnectorRunsData, ThrowOnError>) => (options.client ?? client).get<GetConnectorRunsResponses, GetConnectorRunsErrors, ThrowOnError>({ url: '/api/knowledge-bases/{kgId}/connectors/{id}/runs', ...options });

/**
 * Get a single connector run (including logs)
 */
export const getConnectorRun = <ThrowOnError extends boolean = false>(options: Options<GetConnectorRunData, ThrowOnError>) => (options.client ?? client).get<GetConnectorRunResponses, GetConnectorRunErrors, ThrowOnError>({ url: '/api/knowledge-bases/{kgId}/connectors/{id}/runs/{runId}', ...options });
