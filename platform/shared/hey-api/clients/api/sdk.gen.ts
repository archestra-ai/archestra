 ...
 */
export const getAuditEvents = <ThrowOnError extends boolean = false>(options?: Options<GetAuditEventsData, ThrowOnError>) => (options?.client ?? client).get<GetAuditEventsResponses, GetAuditEventsErrors, ThrowOnError>({ url: '/api/audit-events', ...options });
 ...
 * `auditLog:read`: View the audit trail of administrative actions
 */
export const streamAuditEvents = <ThrowOnError extends boolean = false>(options?: Options<StreamAuditEventsData, ThrowOnError>) => (options?.client ?? client).get<StreamAuditEventsResponses, unknown, ThrowOnError>({ url: '/api/audit-events/stream', ...options });
