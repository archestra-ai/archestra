 ...
 * @param apiKey - API key (optional for Gemini when Vertex AI is enabled, optional for vLLM)
 * @param model - Model name (required for vLLM since it can serve various models)
 */
