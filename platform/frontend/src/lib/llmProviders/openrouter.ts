...
class OpenRouterChatCompletionInteraction implements InteractionUtils {
  private request: archestraApiTypes.OpenRouterChatCompletionRequest;
  private response: archestraApiTypes.OpenRouterChatCompletionResponse;
  modelName: string;

  constructor(interaction: Interaction) {
    this.request =
      interaction.request as archestraApiTypes.OpenRouterChatCompletionRequest;
    this.response =
      interaction.response as archestraApiTypes.OpenRouterChatCompletionResponse;
  ...
  private mapToUiMessage(
    message:
      | archestraApiTypes.OpenRouterChatCompletionRequest["messages"][number]
      | archestraApiTypes.OpenRouterChatCompletionResponse["choices"][number]["message"],
  ): PartialUIMessage {
    ...
    const openrouterRoleToUIMessageRoleMap: Record<
      archestraApiTypes.OpenRouterChatCompletionRequest["messages"][number]["role"],
    ...
    return {
      role: openrouterRoleToUIMessageRoleMap[role],
      parts,
    };
  }
