 ...
 */
export const postApiOnboardingComplete = <ThrowOnError extends boolean = false>(options?: Options<PostApiOnboardingCompleteData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostApiOnboardingCompleteResponses, PostApiOnboardingCompleteErrors, ThrowOnError>({
