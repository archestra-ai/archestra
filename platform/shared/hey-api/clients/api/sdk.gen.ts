...
import type { SimulateToolInvocationPolicyData, SimulateToolInvocationPolicyErrors, SimulateToolInvocationPolicyResponses } from './types.gen';
 ...
 * `toolPolicy:read`: View tools, tool invocation policies, and trusted data policies
 */
export const simulateToolInvocationPolicy = <ThrowOnError extends boolean = false>(options: Options<SimulateToolInvocationPolicyData, ThrowOnError>) => (options.client ?? client).post<SimulateToolInvocationPolicyResponses, SimulateToolInvocationPolicyErrors, ThrowOnError>({
