 ...
 * `app:create`: Create new MCP Apps
 */
export const openNewAppBuilder = <ThrowOnError extends boolean = false>(options?: Options<OpenNewAppBuilderData, ThrowOnError>) => (options?.client ?? client).post<OpenNewAppBuilderResponses, OpenNewAppBuilderErrors, ThrowOnError>({ url: '/api/apps/builder', ...options });
 ...
 * `app:update`: Modify MCP Apps, their tools, and their team assignments
 */
export const openAppBuilder = <ThrowOnError extends boolean = false>(options: Options<OpenAppBuilderData, ThrowOnError>) => (options.client ?? client).get<OpenAppBuilderResponses, OpenAppBuilderErrors, ThrowOnError>({ url: '/api/apps/{appId}/builder', ...options });
 ...
 * `app:read`: View and run MCP Apps within your scope (org, your teams, your own)
 */
export const getAppBuilderBinding = <ThrowOnError extends boolean = false>(options: Options<GetAppBuilderBindingData, ThrowOnError>) => (options.client ?? client).get<GetAppBuilderBindingResponses, GetAppBuilderBindingErrors, ThrowOnError>({ url: '/api/apps/builder-binding', ...options });
 ...
 * `sandbox:execute`: Run commands and upload/download files in code execution sandboxes
 */
export const getSkillSandboxFiles = <ThrowOnError extends boolean = false>(options?: Options<GetSkillSandboxFilesData, ThrowOnError>) => (options?.client ?? client).get<GetSkillSandboxFilesResponses, GetSkillSandboxFilesErrors, ThrowOnError>({ url: '/api/skill-sandbox/files', ...options });
