...
| `remedy_offers` | `object[]` | No | Added by the proxy: the live remedy offers this question may decide. Do not set this yourself. |
| `remedy_offers[].protected` | `string` | Yes |  |
| `remedy_offers[].payload` | `string` | Yes |  |
| `remedy_offers[].signature` | `string` | Yes |  |
