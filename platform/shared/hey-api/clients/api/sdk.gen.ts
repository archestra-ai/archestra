 ...
 * None (no additional RBAC permission required)
 */
export const setMemberDefaultAgent = <ThrowOnError extends boolean = false>(options: Options<SetMemberDefaultAgentData, ThrowOnError>) => (options?.client ?? client).put<SetMemberDefaultAgentResponses, SetMemberDefaultAgentErrors, ThrowOnError>({ url: '/api/members/default-agent', ...options });
