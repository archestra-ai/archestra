...
type GroqRequest = Groq.Types.ChatCompletionRequest;
type GroqResponse = Groq.Types.ChatCompletionResponse;
type GroqMessages = Groq.Types.ChatCompletionRequest["messages"];
type GroqHeaders = Groq.Types.ChatCompletionsHeaders;
type GroqStreamChunk = Groq.Types.ChatCompletionResponse;
