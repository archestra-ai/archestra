...
CREATE INDEX "chat_active_run_events_run_id_seq_idx" ON "chat_active_run_events" USING btree ("run_id","seq");--> statement-breakpoint
CREATE INDEX "chat_active_runs_conversation_id_idx" ON "chat_active_runs" USING btree ("conversation_id");--> statement-breakpoint
CREATE UNIQUE INDEX "chat_active_runs_running_conversation_uidx" ON "chat_active_runs" USING btree ("conversation_id") WHERE "chat_active_runs"."status" = 'running';