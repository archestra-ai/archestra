...
| `draft_skill_from_agent` | Convert an internal agent into a draft SKILL.md manifest for review. | `agent:read` |
...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `id` | `string` | Yes | The ID of the agent to convert into a skill draft. Use list_agents or get_agent to look it up by name. |
