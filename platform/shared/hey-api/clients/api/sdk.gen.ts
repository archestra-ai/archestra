 ...
 */
export const updateMemberRole = <ThrowOnError extends boolean = false>(options: Options<UpdateMemberRoleData, ThrowOnError>) => (options.client ?? client).delete<UpdateMemberRoleResponses, UpdateMemberRoleErrors, ThrowOnError>({ url: '/api/members/{userId}/role', ...options });

/**
 * Update a member's role in the organization. Use this to assign or change roles.
 */
export const updateMemberRole2 = <ThrowOnError extends boolean = false>(options: Options<UpdateMemberRole2Data, ThrowOnError>) => (options.client ?? client).put<UpdateMemberRole2Responses, UpdateMemberRole2Errors, ThrowOnError>({
