...
/**
 * Replace the labels on one of the environments. Labels-only, so a row can be relabelled without resending the rest of its update payload — several entities validate across fields, or rewrite versioned content, on their normal update.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const setEnvironmentLabels = <ThrowOnError extends boolean = false>(options: Options<SetEnvironmentLabelsData, ThrowOnError>) => (options.client ?? client).put<SetEnvironmentLabelsResponses, SetEnvironmentLabelsErrors, ThrowOnError>({
    url: '/api/environments/{id}/labels',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Replace the labels on one of the knowledge bases. Labels-only, so a row can be relabelled without resending the rest of its update payload — several entities validate across fields, or rewrite versioned content, on their normal update.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const setKnowledgeBaseLabels = <ThrowOnError extends boolean = false>(options: Options<SetKnowledgeBaseLabelsData, ThrowOnError>) => (options.client ?? client).put<SetKnowledgeBaseLabelsResponses, SetKnowledgeBaseLabelsErrors, ThrowOnError>({
    url: '/api/knowledge-bases/{id}/labels',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Replace the labels on one of the knowledge connectors. Labels-only, so a row can be relabelled without resending the rest of its update payload — several entities validate across fields, or rewrite versioned content, on their normal update.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeSource:update`: Modify Knowledge Bases and Connectors
 */
export const setConnectorLabels = <ThrowOnError extends boolean = false>(options: Options<SetConnectorLabelsData, ThrowOnError>) => (options.client ?? client).put<SetConnectorLabelsResponses, SetConnectorLabelsErrors, ThrowOnError>({
    url: '/api/knowledge-base-connectors/{id}/labels',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Replace the labels on one of the knowledge files. Labels-only, so a row can be relabelled without resending the rest of its update payload — several entities validate across fields, or rewrite versioned content, on their normal update.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeSource:update`: Modify Knowledge Bases and Connectors
 */
export const setKnowledgeFileLabels = <ThrowOnError extends boolean = false>(options: Options<SetKnowledgeFileLabelsData, ThrowOnError>) => (options.client ?? client).put<SetKnowledgeFileLabelsResponses, SetKnowledgeFileLabelsErrors, ThrowOnError>({
    url: '/api/knowledge-files/{id}/labels',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Replace the labels on one of the limits. Labels-only, so a row can be relabelled without resending the rest of its update payload — several entities validate across fields, or rewrite versioned content, on their normal update.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `llmLimit:update`: Modify existing usage limits
 */
export const setLimitLabels = <ThrowOnError extends boolean = false>(options: Options<SetLimitLabelsData, ThrowOnError>) => (options.client ?? client).put<SetLimitLabelsResponses, SetLimitLabelsErrors, ThrowOnError>({
    url: '/api/limits/{id}/labels',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Replace the labels on one of the models. Labels-only, so a row can be relabelled without resending the rest of its update payload — several entities validate across fields, or rewrite versioned content, on their normal update.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const setLlmProviderModelLabels = <ThrowOnError extends boolean = false>(options: Options<SetLlmProviderModelLabelsData, ThrowOnError>) => (options.client ?? client).put<SetLlmProviderModelLabelsResponses, SetLlmProviderModelLabelsErrors, ThrowOnError>({
    url: '/api/llm-provider-models/{id}/labels',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Replace the labels on one of the LLM OAuth clients. Labels-only, so a row can be relabelled without resending the rest of its update payload — several entities validate across fields, or rewrite versioned content, on their normal update.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const setLlmOauthClientLabels = <ThrowOnError extends boolean = false>(options: Options<SetLlmOauthClientLabelsData, ThrowOnError>) => (options.client ?? client).put<SetLlmOauthClientLabelsResponses, SetLlmOauthClientLabelsErrors, ThrowOnError>({
    url: '/api/llm-oauth-clients/{id}/labels',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Replace the labels on one of the model provider API keys. Labels-only, so a row can be relabelled without resending the rest of its update payload — several entities validate across fields, or rewrite versioned content, on their normal update.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const setLlmProviderApiKeyLabels = <ThrowOnError extends boolean = false>(options: Options<SetLlmProviderApiKeyLabelsData, ThrowOnError>) => (options.client ?? client).put<SetLlmProviderApiKeyLabelsResponses, SetLlmProviderApiKeyLabelsErrors, ThrowOnError>({
    url: '/api/llm-provider-api-keys/{id}/labels',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Replace the labels on one of the MCP OAuth clients. Labels-only, so a row can be relabelled without resending the rest of its update payload — several entities validate across fields, or rewrite versioned content, on their normal update.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const setMcpOauthClientLabels = <ThrowOnError extends boolean = false>(options: Options<SetMcpOauthClientLabelsData, ThrowOnError>) => (options.client ?? client).put<SetMcpOauthClientLabelsResponses, SetMcpOauthClientLabelsErrors, ThrowOnError>({
    url: '/api/mcp-oauth-clients/{id}/labels',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Replace the labels on one of the plugins. Labels-only, so a row can be relabelled without resending the rest of its update payload — several entities validate across fields, or rewrite versioned content, on their normal update.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const setPluginLabels = <ThrowOnError extends boolean = false>(options: Options<SetPluginLabelsData, ThrowOnError>) => (options.client ?? client).put<SetPluginLabelsResponses, SetPluginLabelsErrors, ThrowOnError>({
    url: '/api/plugins/{id}/labels',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Replace the labels on one of the service accounts. Labels-only, so a row can be relabelled without resending the rest of its update payload — several entities validate across fields, or rewrite versioned content, on their normal update.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const setServiceAccountLabels = <ThrowOnError extends boolean = false>(options: Options<SetServiceAccountLabelsData, ThrowOnError>) => (options.client ?? client).put<SetServiceAccountLabelsResponses, SetServiceAccountLabelsErrors, ThrowOnError>({
    url: '/api/service-accounts/{id}/labels',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Replace the labels on one of the skills. Labels-only, so a row can be relabelled without resending the rest of its update payload — several entities validate across fields, or rewrite versioned content, on their normal update.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const setSkillLabels = <ThrowOnError extends boolean = false>(options: Options<SetSkillLabelsData, ThrowOnError>) => (options.client ?? client).put<SetSkillLabelsResponses, SetSkillLabelsErrors, ThrowOnError>({
    url: '/api/skills/{id}/labels',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Replace the labels on one of the virtual API keys. Labels-only, so a row can be relabelled without resending the rest of its update payload — several entities validate across fields, or rewrite versioned content, on their normal update.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const setVirtualApiKeyLabels = <ThrowOnError extends boolean = false>(options: Options<SetVirtualApiKeyLabelsData, ThrowOnError>) => (options.client ?? client).put<SetVirtualApiKeyLabelsResponses, SetVirtualApiKeyLabelsErrors, ThrowOnError>({
    url: '/api/llm-virtual-keys/{id}/labels',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
