...
/**
 * Revoke sharing of an Agent Runtime run
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * None (no additional RBAC permission required)
 */
export const unshareAgentRun = <ThrowOnError extends boolean = false>(options: Options<UnshareAgentRunData, ThrowOnError>) => (options.client ?? client).delete<UnshareAgentRunResponses, UnshareAgentRunErrors, ThrowOnError>({ url: '/api/agent-runs/{taskId}/share', ...options });

/**
 * Get share status for an Agent Runtime run
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * None (no additional RBAC permission required)
 */
export const getAgentRunShare = <ThrowOnError extends boolean = false>(options: Options<GetAgentRunShareData, ThrowOnError>) => (options.client ?? client).get<GetAgentRunShareResponses, GetAgentRunShareErrors, ThrowOnError>({ url: '/api/agent-runs/{taskId}/share', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const shareAgentRun = <ThrowOnError extends boolean = false>(options: Options<ShareAgentRunData, ThrowOnError>) => (options.client ?? client).put<ShareAgentRunResponses, ShareAgentRunErrors, ThrowOnError>({
 ...
 * `toolPolicy:update`: Modify tools, tool configuration, and security policies
 */
export const deleteOpenappaBatteryPackage = <ThrowOnError extends boolean = false>(options: Options<DeleteOpenappaBatteryPackageData, ThrowOnError>) => (options.client ?? client).delete<DeleteOpenappaBatteryPackageResponses, DeleteOpenappaBatteryPackageErrors, ThrowOnError>({ url: '/api/openappa/battery-packages/{name}', ...options });
