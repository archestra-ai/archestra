 ...
 */
export const deleteSiteAnnouncement = <ThrowOnError extends boolean = false>(options?: Options<DeleteSiteAnnouncementData, ThrowOnError>) => (options?.client ?? client).delete<DeleteSiteAnnouncementResponses, unknown, ThrowOnError>({ url: '/api/site-announcement', ...options });

/**
 * Get the active site announcement
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const getSiteAnnouncement = <ThrowOnError extends boolean = false>(options?: Options<GetSiteAnnouncementData, ThrowOnError>) => (options?.client ?? client).get<GetSiteAnnouncementResponses, unknown, ThrowOnError>({ url: '/api/site-announcement', ...options });

/**
 * Update the site announcement
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const updateSiteAnnouncement = <ThrowOnError extends boolean = false>(options: Options<UpdateSiteAnnouncementData, ThrowOnError>) => (options.client ?? client).patch<UpdateSiteAnnouncementResponses, unknown, ThrowOnError>({
 ...
 */
export const createSiteAnnouncement = <ThrowOnError extends boolean = false>(options: Options<CreateSiteAnnouncementData, ThrowOnError>) => (options.client ?? client).post<CreateSiteAnnouncementResponses, unknown, ThrowOnError>({
    url: '/api/site-announcement',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 * `siteAnnouncement:read`: View site-wide announcements
 */
export const getSiteAnnouncementSettings = <ThrowOnError extends boolean = false>(options?: Options<GetSiteAnnouncementSettingsData, ThrowOnError>) => (options?.client ?? client).get<GetSiteAnnouncementSettingsResponses, unknown, ThrowOnError>({ url: '/api/site-announcement/settings', ...options });
