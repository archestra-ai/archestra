...
/**
 * Update the title of an uploaded file
 */
export const updateConnectorFile = <ThrowOnError extends boolean = false>(options: Options<UpdateConnectorFileData, ThrowOnError>) => (options.client ?? client).patch<UpdateConnectorFileResponses, UpdateConnectorFileErrors, ThrowOnError>({
 ...
 */
export const deleteConnectorFile = <ThrowOnError extends boolean = false>(options: Options<DeleteConnectorData, ThrowOnError>) => (options.client ?? client).delete<DeleteConnectorFileResponse, DeleteConnectorFileErrors, ThrowOnError>({ url: '/api/connectors/{id}/files/{fileId}', ...options });
