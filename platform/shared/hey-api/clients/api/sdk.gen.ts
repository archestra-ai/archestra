 ...
 */
export const getScheduleTriggerAvailableReplyChannels = <ThrowOnError extends boolean = false>(options: Options<GetScheduleTriggerAvailableReplyChannelsData, ThrowOnError>) => (options.client ?? client).get<GetScheduleTriggerAvailableReplyChannelsResponses, GetScheduleTriggerAvailableReplyChannelsErrors, ThrowOnError>({ url: '/api/schedule-triggers/available-reply-channels', ...options });
 ...
 * `scheduledTask:create`: Create new scheduled tasks and trigger runs
 */
export const createScheduleTriggerFromConversation = <ThrowOnError extends boolean = false>(options: Options<CreateScheduleTriggerFromConversationData, ThrowOnError>) => (options.client ?? client).post<CreateScheduleTriggerFromConversationResponses, CreateScheduleTriggerFromConversationErrors, ThrowOnError>({
 ...
 * `scheduledTask:read`: View scheduled tasks and their run history
 */
export const getConversationScheduleTriggerSuggestion = <ThrowOnError extends boolean = false>(options: Options<GetConversationScheduleTriggerSuggestionData, ThrowOnError>) => (options.client ?? client).get<GetConversationScheduleTriggerSuggestionResponses, GetConversationScheduleTriggerSuggestionErrors, ThrowOnError>({ url: '/api/conversations/{id}/schedule-trigger-suggestion', ...options });
