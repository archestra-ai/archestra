...
| `cleanup_interval` | `"1h" \| "12h" \| "24h" \| "1w" \| "1m" \| null` | No | Optional cleanup interval for resetting this limit's usage. |
...
| `limit.cleanupInterval` | `"1h" \| "12h" \| "24h" \| "1w" \| "1m" \| null` | Yes | Cleanup interval for resetting this limit's usage. |
...
| `limits[].cleanupInterval` | `"1h" \| "12h" \| "24h" \| "1w" \| "1m" \| null` | Yes | Cleanup interval for resetting this limit's usage. |
...
| `cleanup_interval` | `"1h" \| "12h" \| "24h" \| "1w" \| "1m" \| null` | No | Optional new cleanup interval. |
