...
class GroqChatCompletionInteraction implements InteractionUtils {
  private request: archestraApiTypes.GroqChatCompletionRequest;
  private response: archestraApiTypes.GroqChatCompletionResponse;
  modelName: string;

  constructor(interaction: Interaction) {
    this.request =
      interaction.request as archestraApiTypes.GroqChatCompletionRequest;
    this.response =
      interaction.response as archestraApiTypes.GroqChatCompletionResponse;
  ...
  private mapToUiMessage(
    message:
      | archestraApiTypes.GroqChatCompletionRequest["messages"][number]
      | archestraApiTypes.GroqChatCompletionResponse["choices"][number]["message"],
  ): PartialUIMessage {
    ...
    const GroqRoleToUIMessageRoleMap: Record<
      archestraApiTypes.GroqChatCompletionRequest["messages"][number]["role"],
