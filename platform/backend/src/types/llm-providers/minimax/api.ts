...
// MiniMax API schemas (OpenAI-compatible)
...
export const ChatCompletionUsageSchema = z
  ...
  .describe("Token usage information from MiniMax API");
...
const ChoiceSchema = z
  ...
  .describe("Choice in MiniMax chat completion response");
...
export const ChatCompletionRequestSchema = z
  ...
  .describe("Request body for MiniMax chat completions API");
...
export const ChatCompletionResponseSchema = z
  ...
  .describe("Response from MiniMax chat completions API");

export const ChatCompletionsHeadersSchema = z.object({
  "user-agent": z.string().optional().describe("The user agent of the client"),
  authorization: z
    .string()
    .describe("Bearer token for MiniMax API")
...
export const ChatCompletionChunkSchema = z
  ...
  .describe("Streaming chunk from MiniMax chat completions API");
