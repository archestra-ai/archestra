 ...
 */
export const LIGHT_ONLY_THEMES = ["bubblegum"] as const satisfies readonly (typeof SUPPORTED_THEMES)[number][];

/**
 * Themes that only support dark mode (no light variant)
 */
export const DARK_ONLY_THEMES = ["solarized-dark", "gruvbox-dark", "dracula-dark", "monokai-dark", "moonlight-dark"] as const satisfies readonly (typeof SUPPORTED_THEMES)[number][];
