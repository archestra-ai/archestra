...
| `knowledgeGraph:create` | Create new knowledge graphs for rag-based document retrieval |
| `knowledgeGraph:read` | View and list knowledge graphs for rag-based document retrieval |
| `knowledgeGraph:update` | Modify existing knowledge graphs for rag-based document retrieval |
| `knowledgeGraph:delete` | Remove existing knowledge graphs for rag-based document retrieval |
