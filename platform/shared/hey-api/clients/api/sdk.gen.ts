 ...
 */
export const createDmIntent = <ThrowOnError extends boolean = false>(options: Options<CreateDmIntentData, ThrowOnError>) => (options.client ?? client).post<CreateDmIntentResponses, CreateDmIntentErrors, ThrowOnError>({
    url: '/api/chatops/dm-intent',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
