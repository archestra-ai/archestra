...
import openAiProxyRoutesV1 from "./proxy/cerebras";
...
import openAiProxyRoutesV2 from "./proxy/routesv2/cerebras";
...
export const openAiProxyRoutes = config.llm.cerebras.useV2Routes
  ? openAiProxyRoutesV2
  : openAiProxyRoutesV1;
