 ...
 */
export const getProfileTokens = <ThrowOnError extends boolean = false>(options: Options<GetProfileTokensData, ThrowOnError>) => (options.client ?? client).get<GetProfileTokensResponses, GetProfileTokensErrors, ThrowOnError>({ url: '/api/profiles/{profileId}/tokens', ...options });

/**
 * Create a new token for a profile
 */
export const createProfileToken = <ThrowOnError extends boolean = false>(options: Options<CreateProfileTokenData, ThrowOnError>) => (options.client ?? client).post<CreateProfileTokenResponses, CreateProfileTokenErrors, ThrowOnError>({
    url: '/api/profiles/{profileId}/tokens',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * Delete a token
 */
export const deleteProfileToken = <ThrowOnError extends boolean = false>(options: Options<DeleteProfileTokenData, ThrowOnError>) => (options.client ?? client).delete<DeleteProfileTokenResponses, DeleteProfileTokenErrors, ThrowOnError>({ url: '/api/profiles/{profileId}/tokens/{tokenId}', ...options });

/**
 * Update a token
 */
export const updateProfileToken = <ThrowOnError extends boolean = false>(options: Options<UpdateProfileTokenData, ThrowOnError>) => (options.client ?? client).patch<UpdateProfileTokenResponses, UpdateProfileTokenErrors, ThrowOnError>({
    url: '/api/profiles/{profileId}/tokens/{tokenId}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 */
export const rotateProfileToken = <ThrowOnError extends boolean = false>(options: Options<RotateProfileTokenData, ThrowOnError>) => (options.client ?? client).post<RotateProfileTokenResponses, RotateProfileTokenErrors, ThrowOnError>({ url: '/api/profiles/{profileId}/tokens/{tokenId}/rotate', ...options });
