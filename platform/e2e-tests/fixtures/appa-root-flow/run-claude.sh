...
# the proxy canonicalize `mcp__<label>__archestra__*` back to the built-in APPA
# tools. A label that matches no gateway leaves the tools foreign, and APPA
# refuses a session it cannot see its control and notice tools in.
