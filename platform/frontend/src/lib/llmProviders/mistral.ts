/**
 * Mistral AI Interaction Utils
 *
 * Mistral exposes an OpenAI-compatible API, so we can reuse the OpenAI interaction class.
 ...
 * This class handles Mistral chat completion interactions identically to OpenAI.
 */
class MistralChatCompletionInteraction implements InteractionUtils {
  // Mistral uses OpenAI-compatible types
  ...
  private mapToUiMessage(
    ...
    return {
      role: mistralRoleToUIMessageRoleMap[role],
      parts,
    };
  }
