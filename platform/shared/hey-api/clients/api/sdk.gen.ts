...
/**
 * Proxy connection page sub-requests from a bundled ChatOps adapter
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `agentTrigger:read`: View agent trigger configurations (Slack, MS Teams, email)
 */
export const getBundledChatOpsAdapterConnectionPage2 = <ThrowOnError extends boolean = false>(options: Options<GetBundledChatOpsAdapterConnectionPage2Data, ThrowOnError>) => (options.client ?? client).get<GetBundledChatOpsAdapterConnectionPage2Responses, unknown, ThrowOnError>({ url: '/api/chatops/generic/builtin-adapters/{adapterId}/connection-page/{*}', ...options });
