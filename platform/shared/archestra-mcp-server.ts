...
export const TOOL_UPLOAD_SKILL_SANDBOX_FILE_SHORT_NAME =
  "upload_skill_sandbox_file";
...
export const TOOL_UPLOAD_SKILL_SANDBOX_FILE_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_UPLOAD_SKILL_SANDBOX_FILE_SHORT_NAME}` as const;
