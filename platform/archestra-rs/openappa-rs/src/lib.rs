...
mod typed_tests {
    use super::{
        OfferId, OfferOwner, RemedyOutcome, RemedyPresentation, owner_can_be_spent_by,
        presentation_offer_ids, render_released_call, render_remedy_outcome,
    };
    ...
    fn authorized_remedy_uses_released_arguments_and_saved_spelling() {
        ...
        assert_eq!(
            prefix,
            "[appa] Authorized. Call the client_tool tool again with "
        );
        assert_eq!(
