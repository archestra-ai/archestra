 ...
 */
export const invalidateChatModelsCache = <ThrowOnError extends boolean = false>(options?: Options<InvalidateChatModelsCacheData, ThrowOnError>) => (options?.client ?? client).post<InvalidateChatModelsCacheResponses, InvalidateChatModelsCacheErrors, ThrowOnError>({ url: '/api/chat/models/invalidate-cache', ...options });
...
export const deleteV1McpCacheByProfileId = <ThrowOnError extends boolean = false>(options: Options<DeleteV1McpCacheByProfileIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteV1McpCacheByProfileIdResponses, DeleteV1McpCacheByProfileIdErrors, ThrowOnError>({ url: '/v1/mcp/cache/{profileId}', ...options });
 ...
 */
export const getOrganizationMembers = <ThrowOnError extends boolean = false>(options?: Options<GetOrganizationMembersData, ThrowOnError>) => (options?.client ?? client).get<GetOrganizationMembersResponses, GetOrganizationMembersErrors, ThrowOnError>({ url: '/api/members', ...options });

/**
 * Get a specific member by user ID
 */
export const getOrganizationMember = <ThrowOnError extends boolean = false>(options: Options<GetOrganizationMemberData, ThrowOnError>) => (options.client ?? client).get<GetOrganizationMemberResponses, GetOrganizationMemberErrors, ThrowOnError>({ url: '/api/members/{userId}', ...options });

/**
 * Reset a member's role to the default 'member' role. This effectively unassigns any custom or elevated role.
 */
export const resetMemberRole = <ThrowOnError extends boolean = false>(options: Options<ResetMemberRoleData, ThrowOnError>) => (options.client ?? client).delete<ResetMemberRoleResponses, ResetMemberRoleErrors, ThrowOnError>({ url: '/api/members/{userId}/role', ...options });
 ...
 */
export const getUserById = <ThrowOnError extends boolean = false>(options: Options<GetUserByIdData, ThrowOnError>) => (options.client ?? client).get<GetUserByIdResponses, GetUserByIdErrors, ThrowOnError>({ url: '/api/users/{userId}', ...options });

/**
 * Look up a user by their email address. Returns user details and their membership in the current organization.
 */
export const getUserByEmail = <ThrowOnError extends boolean = false>(options: Options<GetUserByEmailData, ThrowOnError>) => (options.client ?? client).get<GetUserByEmailResponses, GetUserByEmailErrors, ThrowOnError>({ url: '/api/users/by-email/{email}', ...options });
 ...
 */
export const getRoleByName = <ThrowOnError extends boolean = false>(options: Options<GetRoleByNameData, ThrowOnError>) => (options.client ?? client).get<GetRoleByNameResponses, GetRoleByNameErrors, ThrowOnError>({ url: '/api/roles/by-name/{name}', ...options });
