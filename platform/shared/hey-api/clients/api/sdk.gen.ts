 ...
 */
export const hasPermission = <ThrowOnError extends boolean = false>(options: Options<HasPermissionData, ThrowOnError>) => {
    return (options.client ?? client).post<HasPermissionResponses, HasPermissionErrors, ThrowOnError>({
