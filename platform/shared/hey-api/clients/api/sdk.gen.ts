...
/**
 * List bundles in the active organization
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const getBundles = <ThrowOnError extends boolean = false>(options?: Options<GetBundlesData, ThrowOnError>) => (options?.client ?? client).get<GetBundlesResponses, GetBundlesErrors, ThrowOnError>({ url: '/api/bundles', ...options });
 ...
 */
export const createBundle = <ThrowOnError extends boolean = false>(options: Options<CreateBundleData, ThrowOnError>) => (options.client ?? client).post<CreateBundleResponses, CreateBundleErrors, ThrowOnError>({
    url: '/api/bundles',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const deleteBundle = <ThrowOnError extends boolean = false>(options: Options<DeleteBundleData, ThrowOnError>) => (options.client ?? client).delete<DeleteBundleResponses, DeleteBundleErrors, ThrowOnError>({ url: '/api/bundles/{id}', ...options });
 ...
 * `bundle:read`: View and apply bundles
 */
export const getBundle = <ThrowOnError extends boolean = false>(options: Options<GetBundleData, ThrowOnError>) => (options.client ?? client).get<GetBundleResponses, GetBundleErrors, ThrowOnError>({ url: '/api/bundles/{id}', ...options });
 ...
 */
export const updateBundle = <ThrowOnError extends boolean = false>(options: Options<UpdateBundleData, ThrowOnError>) => (options.client ?? client).patch<UpdateBundleResponses, UpdateBundleErrors, ThrowOnError>({
    url: '/api/bundles/{id}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
