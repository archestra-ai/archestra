...
/**
 * All execution sessions in a project the caller can read. Sessions started by others require `project:read-all`; all non-owner views are read-only.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `project:read`: View projects and your own sessions inside them
 */
export const getProjectExecutions = <ThrowOnError extends boolean = false>(options: Options<GetProjectExecutionsData, ThrowOnError>) => (options.client ?? client).get<GetProjectExecutionsResponses, GetProjectExecutionsErrors, ThrowOnError>({ url: '/api/projects/{id}/executions', ...options });
...
/**
 * Revoke sharing of a Background execution
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `agent:read`: View and list agents
 */
export const unshareAgentExecution = <ThrowOnError extends boolean = false>(options: Options<UnshareAgentExecutionData, ThrowOnError>) => (options.client ?? client).delete<UnshareAgentExecutionResponses, UnshareAgentExecutionErrors, ThrowOnError>({ url: '/api/agent-executions/{taskId}/share', ...options });

/**
 * Get share status for a Background execution
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `agent:read`: View and list agents
 */
export const getAgentExecutionShare = <ThrowOnError extends boolean = false>(options: Options<GetAgentExecutionShareData, ThrowOnError>) => (options.client ?? client).get<GetAgentExecutionShareResponses, GetAgentExecutionShareErrors, ThrowOnError>({ url: '/api/agent-executions/{taskId}/share', ...options });
 ...
 * `agent:read`: View and list agents
 */
export const shareAgentExecution = <ThrowOnError extends boolean = false>(options: Options<ShareAgentExecutionData, ThrowOnError>) => (options.client ?? client).put<ShareAgentExecutionResponses, ShareAgentExecutionErrors, ThrowOnError>({
