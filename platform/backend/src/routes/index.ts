...
// Cerebras proxy routes - V2 only (unified handler, OpenAI-compatible)
export const cerebrasProxyRoutes = config.llm.cerebras.useV2Routes
  ? cerebrasProxyRoutesV2
  : cerebrasProxyRoutesV2; // Cerebras only has V2 since it was added after the unified handler
