...
module.exports.shrinkImageToFit = wrapNativeAsync("shrinkImageToFit");
...
function loadBinding() {
  ...
  throw new Error(
    `Unable to load @archestra/image-rs for ${process.platform}/${process.arch}.${details ? `\n${details}` : ""}`,
  );
}
