 ...
 * `skill:create`: Create new agent skills
 */
export const suggestSkillDescription = <ThrowOnError extends boolean = false>(options: Options<SuggestSkillDescriptionData, ThrowOnError>) => (options.client ?? client).post<SuggestSkillDescriptionResponses, unknown, ThrowOnError>({ url: '/api/agents/{id}/suggest-skill-description', ...options });
