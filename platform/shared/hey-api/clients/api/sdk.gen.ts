 ...
 * `app:update`: Modify MCP Apps, their tools, and their team assignments
 */
export const publishApp = <ThrowOnError extends boolean = false>(options: Options<PublishAppData, ThrowOnError>) => (options.client ?? client).post<PublishAppResponses, PublishAppErrors, ThrowOnError>({ url: '/api/apps/{appId}/publish', ...options });
 ...
 * `app:update`: Modify MCP Apps, their tools, and their team assignments
 */
export const unpublishApp = <ThrowOnError extends boolean = false>(options: Options<UnpublishAppData, ThrowOnError>) => (options.client ?? client).post<UnpublishAppResponses, UnpublishAppErrors, ThrowOnError>({ url: '/api/apps/{appId}/unpublish', ...options });
