...
export type GetChatApiKeysResponses = {
    ...
    200: Array<{
        ...
        name: string;
        provider: 'anthropic' | 'bedrock' | 'cerebras' | 'gemini' | 'openai' | 'vllm' | 'ollama' | 'zhipuai';
...
export type CreateChatConversationData = {
    body: {
        ...
        title?: string | null;
        selectedModel?: string;
        selectedProvider?: 'anthropic' | 'bedrock' | 'cerebras' | 'gemini' | 'openai' | 'vllm' | 'ollama' | 'zhipuai';
        chatApiKeyId?: string | null;
    };
    path?: never;
    query?: never;
...
export type GetOptimizationRulesResponses = {
    ...
    200: Array<{
        ...
        provider: 'openai' | 'gemini' | 'anthropic' | 'bedrock' | 'cerebras' | 'vllm' | 'ollama' | 'zhipuai';
        targetModel: string;
        enabled: boolean;
        createdAt: string;
        updatedAt: string;
