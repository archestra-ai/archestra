...
/**
 * MiniMax API error types (from response body `error.type` field)
 * MiniMax uses string-based error types in OpenAI-compatible format
 * @see https://console.minimax.com/docs/errors
 */
