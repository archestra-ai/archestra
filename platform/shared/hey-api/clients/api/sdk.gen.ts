...
/**
 * Get the active site notification banner
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * Authorization:
 *
 * `siteNotification:read`: View organization-wide site notification banners in the app shell
 */
export const getSiteNotification = <ThrowOnError extends boolean = false>(options?: Options<GetSiteNotificationData, ThrowOnError>) => (options?.client ?? client).get<GetSiteNotificationResponses, GetSiteNotificationErrors, ThrowOnError>({ url: '/api/organization/site-notification', ...options });

/**
 * Update the site notification banner
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * Authorization:
 *
 * `siteNotification:update`: Create, edit, or clear organization-wide site notification banners
 */
export const updateSiteNotification = <ThrowOnError extends boolean = false>(options: Options<UpdateSiteNotificationData, ThrowOnError>) => (options.client ?? client).patch<UpdateSiteNotificationResponses, UpdateSiteNotificationErrors, ThrowOnError>({
