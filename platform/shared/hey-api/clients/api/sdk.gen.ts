 ...
 */
export const getOnboardingSteps = <ThrowOnError extends boolean = false>(options?: Options<GetOnboardingStepsData, ThrowOnError>) => (options?.client ?? client).get<GetOnboardingStepsResponses, GetOnboardingStepsErrors, ThrowOnError>({ url: '/api/onboarding/steps', ...options });
 ...
 */
export const completeOnboardingStep = <ThrowOnError extends boolean = false>(options: Options<CompleteOnboardingStepData, ThrowOnError>) => (options.client ?? client).post<CompleteOnboardingStepResponses, CompleteOnboardingStepErrors, ThrowOnError>({
 ...
 * `onboarding:read`: View your own onboarding progress
 */
export const getOnboardingSurveyStatus = <ThrowOnError extends boolean = false>(options?: Options<GetOnboardingSurveyStatusData, ThrowOnError>) => (options?.client ?? client).get<GetOnboardingSurveyStatusResponses, GetOnboardingSurveyStatusErrors, ThrowOnError>({ url: '/api/onboarding/survey/status', ...options });
