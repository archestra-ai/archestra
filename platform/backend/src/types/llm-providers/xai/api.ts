...
export const ChatCompletionUsageSchema = z
  ...
  .describe("Token usage information from x.ai Grok API");
...
export const ChatCompletionRequestSchema = z
  ...
  .describe("x.ai Grok chat completion request (OpenAI-compatible)");
...
export const ChatCompletionResponseSchema = z
  ...
  .describe("x.ai Grok chat completion response (OpenAI-compatible)");
