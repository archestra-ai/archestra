...
export const SelectLabelValueSchema = createSelectSchema(schema.labelValueTable);
export const InsertLabelValueSchema = createInsertSchema(schema.labelValueTable);

export const SelectAgentLabelSchema = createSelectSchema(schema.agentLabelTable);
export const InsertAgentLabelSchema = createInsertSchema(schema.agentLabelTable);
