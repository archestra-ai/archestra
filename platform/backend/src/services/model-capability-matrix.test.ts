...
const MATRIX: MatrixRow[] = [
  ...
  // --- Bedrock: cross-provider resolution ---------------------------------
  {
    ...
    expected: {
      ...
      outputModalities: ["text"],
      supportsToolCalling: true,
      pricePerMillionInput: "3.30",
      pricePerMillionOutput: "16.50",
      priceSource: "aws",
      pricePerMillionCacheRead: "0.3",
      pricePerMillionCacheWrite: "3.75",
      cachePriceSource: "models_dev",
  ...
  {
    name: "bedrock/global.anthropic.claude-sonnet-4-5 — the global endpoint is priced below the regional one",
    provider: "bedrock",
