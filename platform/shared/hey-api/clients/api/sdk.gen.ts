 ...
 */
export const getApiWebhooksChatopsWhatsapp = <ThrowOnError extends boolean = false>(options?: Options<GetApiWebhooksChatopsWhatsappData, ThrowOnError>) => (options?.client ?? client).get<GetApiWebhooksChatopsWhatsappResponses, GetApiWebhooksChatopsWhatsappErrors, ThrowOnError>({ url: '/api/webhooks/chatops/whatsapp', ...options });

/**
 * WhatsApp Cloud API webhook endpoint
 */
export const postApiWebhooksChatopsWhatsapp = <ThrowOnError extends boolean = false>(options: Options<PostApiWebhooksChatopsWhatsappData, ThrowOnError>) => (options.client ?? client).post<PostApiWebhooksChatopsWhatsappResponses, PostApiWebhooksChatopsWhatsappErrors, ThrowOnError>({
