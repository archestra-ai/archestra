...
class PerplexityChatCompletionInteraction implements InteractionUtils {
  ...
  private mapToUiMessage(
    ...
    const PerplexityRoleToUIMessageRoleMap: Record<
      archestraApiTypes.PerplexityChatCompletionRequest["messages"][number]["role"],
    ...
    return {
      role: PerplexityRoleToUIMessageRoleMap[role],
      parts,
    };
  }
