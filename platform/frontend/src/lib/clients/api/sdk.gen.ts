...
/**
 * Get past responses for a specific tool
 */
export const getPastToolResponses = <ThrowOnError extends boolean = false>(options: Options<GetPastToolResponsesData, ThrowOnError>) => {
    return (options.client ?? client).get<GetPastToolResponsesResponses, GetPastToolResponsesErrors, ThrowOnError>({
 ...
 */
export const previewResponseModifier = <ThrowOnError extends boolean = false>(options: Options<PreviewResponseModifierData, ThrowOnError>) => {
    return (options.client ?? client).post<PreviewResponseModifierResponses, PreviewResponseModifierErrors, ThrowOnError>({
...
export const postV1McpByAgentId = <ThrowOnError extends boolean = false>(options: Options<PostV1McpByAgentIdData, ThrowOnError>) => {
    return (options.client ?? client).post<PostV1McpByAgentIdResponses, PostV1McpByAgentIdErrors, ThrowOnError>({
        url: '/v1/mcp/{agentId}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
