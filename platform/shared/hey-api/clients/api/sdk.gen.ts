 ...
 * This route accepts either an LLM provider API key or a Virtual API Key. See [LLM Proxy Authentication](/docs/platform-llm-proxy-authentication).
 */
export const perplexityAgentResponsesWithDefaultAgent = <ThrowOnError extends boolean = false>(options: Options<PerplexityAgentResponsesWithDefaultAgentData, ThrowOnError>) => (options.client ?? client).post<PerplexityAgentResponsesWithDefaultAgentResponses, PerplexityAgentResponsesWithDefaultAgentErrors, ThrowOnError>({
    url: '/v1/perplexity-agent/responses',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * This route accepts either an LLM provider API key or a Virtual API Key. See [LLM Proxy Authentication](/docs/platform-llm-proxy-authentication).
 */
export const perplexityAgentResponsesWithAgent = <ThrowOnError extends boolean = false>(options: Options<PerplexityAgentResponsesWithAgentData, ThrowOnError>) => (options.client ?? client).post<PerplexityAgentResponsesWithAgentResponses, PerplexityAgentResponsesWithAgentErrors, ThrowOnError>({
    url: '/v1/perplexity-agent/{agentId}/responses',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
