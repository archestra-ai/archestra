...
The LLM Proxy supports direct provider API keys, virtual API keys, LLM application access tokens, and JWKS via an external identity provider. See [Authentication](/docs/platform-llm-proxy-authentication) for details.
