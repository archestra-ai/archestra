...
Because Mastra agents are built with code, they can have broad access to your systems and data. That access becomes a risk when agents process content from untrusted sources. Mastra agents are vulnerable to the [lethal trifecta](/docs/platform-lethal-trifecta), a dangerous combination of:
