...
| `output` | `string` | Yes | The JSON-serialized value archestra.tools.call resolves with for this result (the full envelope is available in app code via archestra.tools.callRaw), framed as untrusted data. |
