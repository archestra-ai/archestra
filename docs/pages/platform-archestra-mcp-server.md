...
Most tools require explicit assignment to Agents or MCP Gateways before they can be used. The following tools are pre-installed on all new agents by default: [`artifact_write`](#artifact_write), [`todo_write`](#todo_write), [`activate_skill`](#activate_skill), [`read_skill_file`](#read_skill_file).
