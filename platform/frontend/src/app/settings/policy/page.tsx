...
import { ShieldCheck, Sparkles, XCircle } from "lucide-react";
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  Automatically analyze and configure security policies when
                  tools are assigned
                </p>
              </div>
              <Switch
          ...
          <div className="space-y-2">
            ...
            <div className="bg-muted rounded-md p-4 font-mono text-xs whitespace-pre-wrap break-words overflow-x-auto overflow-y-auto">
              {promptTemplate}
            </div>
          </div>
        </CardContent>
