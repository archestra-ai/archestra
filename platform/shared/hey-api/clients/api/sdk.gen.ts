...
/**
 * Get available Anthropic models for chat
 */
export const getApiChatModels = <ThrowOnError extends boolean = false>(options?: Options<GetApiChatModelsData, ThrowOnError>) => (options?.client ?? client).get<GetApiChatModelsResponses, GetApiChatModelsErrors, ThrowOnError>({ url: '/api/chat/models', ...options });
