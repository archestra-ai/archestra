...
- **MCP Logs**: <http://localhost:9000/api/mcp_server/:id/logs> (GET container logs, supports ?follow=true for streaming)
...
- Pod logs available via `/api/mcp_server/:id/logs` (supports ?follow=true for streaming)
