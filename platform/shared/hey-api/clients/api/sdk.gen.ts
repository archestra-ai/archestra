...
/**
 * List prompt version history for an agent
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Get a single prompt version snapshot
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * None (no additional RBAC permission required)
 */
export const getAgentVersion = <ThrowOnError extends boolean = false>(options: Options<GetAgentVersionData, ThrowOnError>) => (options.client ?? client).get<GetAgentVersionResponses, GetAgentVersionErrors, ThrowOnError>({ url: '/api/agents/{id}/versions/{versionId}', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const getAgentVersionDiff = <ThrowOnError extends boolean = false>(options: Options<GetAgentVersionDiffData, ThrowOnError>) => (options.client ?? client).get<GetAgentVersionDiffResponses, GetAgentVersionDiffErrors, ThrowOnError>({ url: '/api/agents/{id}/versions/{versionId}/diff', ...options });
...
export const restoreAgentVersion = <ThrowOnError extends boolean = false>(options: Options<RestoreAgentVersionData, ThrowOnError>) => (options.client ?? client).post<RestoreAgentVersionResponses, RestoreAgentVersionErrors, ThrowOnError>({
    url: '/api/agents/{id}/versions/{versionId}/restore',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
