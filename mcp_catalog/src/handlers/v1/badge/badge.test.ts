...
describe('GET /v1/badge/*', () => {
  ...
  it('should return a badge for a server with high quality score', async () => {
    const response = await app.inject({
      method: 'GET',
      url: '/badge/quality/test-org/test-repo',
    });
  ...
  it('should return a badge for a server with medium quality score', async () => {
    const response = await app.inject({
      method: 'GET',
      url: '/badge/quality/test-org-2/test-repo-2/packages--server',
    });
  ...
  it('should return a pending badge for server with null quality score', async () => {
    const response = await app.inject({
      method: 'GET',
      url: '/badge/quality/pending-server/pending-repo',
    });
  ...
  it('should return a calculating badge for non-existent server', async () => {
    const response = await app.inject({
      method: 'GET',
      url: '/badge/quality/non-existent/repo',
    });
  ...
  it('should return 400 for invalid format without quality prefix', async () => {
    const response = await app.inject({
      method: 'GET',
      url: '/badge/invalid/test-org/test-repo',
    });

    expect(response.statusCode).toBe(400);
    const json = response.json();
    expect(json.error).toBe('Invalid format. Use: /api/v1/badge/quality/github-org/repo-name[/path--to--server]');
  });
