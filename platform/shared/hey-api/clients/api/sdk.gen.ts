 ...
 */
export const bedrockConverseWithDefaultAgentModel = <ThrowOnError extends boolean = false>(options: Options<BedrockConverseWithDefaultAgentModelData, ThrowOnError>) => (options.client ?? client).post<BedrockConverseWithDefaultAgentModelResponses, BedrockConverseWithDefaultAgentModelErrors, ThrowOnError>({
