 ...
 */
export const updateUserOnboarding = <ThrowOnError extends boolean = false>(options: Options<UpdateUserOnboardingData, ThrowOnError>) => {
    return (options.client ?? client).put<UpdateUserOnboardingResponses, UpdateUserOnboardingErrors, ThrowOnError>({
