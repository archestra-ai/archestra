/**
 * xAI (Grok) LLM Proxy Adapter - OpenAI-compatible
 *
 * xAI uses an OpenAI-compatible API at https://api.x.ai/v1
 * This adapter reuses OpenAI's adapter factory with xAI-specific configuration.
 *
 * Since xAI is 100% OpenAI-compatible, we delegate all adapter logic to OpenAI
...
/**
 * xAI request adapter - wraps OpenAI adapter with xAI provider name.
...
/**
 * xAI response adapter - wraps OpenAI adapter with xAI provider name.
 */
...
/**
 * xAI stream adapter - wraps OpenAI adapter with xAI provider name.
 */
