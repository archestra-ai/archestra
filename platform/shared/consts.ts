...
export const TOOL_CREATE_AGENT_FULL_NAME = `${ARCHESTRA_TOOL_PREFIX}create_agent`;
export const TOOL_CREATE_MCP_SERVER_INSTALLATION_REQUEST_FULL_NAME = `${ARCHESTRA_TOOL_PREFIX}create_mcp_server_installation_request`;
export const TOOL_ARTIFACT_WRITE_FULL_NAME = `${ARCHESTRA_TOOL_PREFIX}artifact_write`;
export const TOOL_TODO_WRITE_FULL_NAME = `${ARCHESTRA_TOOL_PREFIX}todo_write`;
export const TOOL_QUERY_KNOWLEDGE_SOURCES_FULL_NAME = `${ARCHESTRA_TOOL_PREFIX}query_knowledge_sources`;
export const TOOL_SWAP_AGENT_FULL_NAME = `${ARCHESTRA_TOOL_PREFIX}swap_agent`;
export const TOOL_SWAP_TO_DEFAULT_AGENT_FULL_NAME = `${ARCHESTRA_TOOL_PREFIX}swap_to_default_agent`;
