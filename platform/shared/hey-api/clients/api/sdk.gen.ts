 ...
 */
export const postApiAgentToolsBulkUpdate = <ThrowOnError extends boolean = false>(options: Options<PostApiAgentToolsBulkUpdateData, ThrowOnError>) => {
    return (options.client ?? client).post<PostApiAgentToolsBulkUpdateResponses, PostApiAgentToolsBulkUpdateErrors, ThrowOnError>({
