...
class CerebrasChatCompletionInteraction implements InteractionUtils {
  private request: archestraApiTypes.CerebrasChatCompletionRequest;
  private response: archestraApiTypes.CerebrasChatCompletionResponse;
  modelName: string;

  constructor(interaction: Interaction) {
    this.request =
      interaction.request as archestraApiTypes.CerebrasChatCompletionRequest;
    this.response =
      interaction.response as archestraApiTypes.CerebrasChatCompletionResponse;
  ...
  private mapToUiMessage(
    message:
      | archestraApiTypes.CerebrasChatCompletionRequest["messages"][number]
      | archestraApiTypes.CerebrasChatCompletionResponse["choices"][number]["message"],
  ): PartialUIMessage {
    ...
    const CerebrasRoleToUIMessageRoleMap: Record<
      archestraApiTypes.CerebrasChatCompletionRequest["messages"][number]["role"],
    ...
    return {
      role: CerebrasRoleToUIMessageRoleMap[role],
      parts,
    };
  }
