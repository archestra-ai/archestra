 ...
 * `agentSettings:update`: Modify agent settings (default model, default agent, default tool guardrails, file uploads, Apps Hackathon recorder)
 */
export const listAppaApprovals = <ThrowOnError extends boolean = false>(options?: Options<ListAppaApprovalsData, ThrowOnError>) => (options?.client ?? client).get<ListAppaApprovalsResponses, ListAppaApprovalsErrors, ThrowOnError>({ url: '/api/appa-approvals', ...options });
 ...
 * `agentSettings:update`: Modify agent settings (default model, default agent, default tool guardrails, file uploads, Apps Hackathon recorder)
 */
export const getAppaApproval = <ThrowOnError extends boolean = false>(options: Options<GetAppaApprovalData, ThrowOnError>) => (options.client ?? client).get<GetAppaApprovalResponses, GetAppaApprovalErrors, ThrowOnError>({ url: '/api/appa-approvals/{id}', ...options });
 ...
 * `agentSettings:update`: Modify agent settings (default model, default agent, default tool guardrails, file uploads, Apps Hackathon recorder)
 */
export const decideAppaApproval = <ThrowOnError extends boolean = false>(options: Options<DecideAppaApprovalData, ThrowOnError>) => (options.client ?? client).post<DecideAppaApprovalResponses, DecideAppaApprovalErrors, ThrowOnError>({
 ...
 * `agentSettings:update`: Modify agent settings (default model, default agent, default tool guardrails, file uploads, Apps Hackathon recorder)
 */
export const listAppaQuarantines = <ThrowOnError extends boolean = false>(options?: Options<ListAppaQuarantinesData, ThrowOnError>) => (options?.client ?? client).get<ListAppaQuarantinesResponses, ListAppaQuarantinesErrors, ThrowOnError>({ url: '/api/appa-quarantines', ...options });
 ...
 * `agentSettings:update`: Modify agent settings (default model, default agent, default tool guardrails, file uploads, Apps Hackathon recorder)
 */
export const getAppaQuarantine = <ThrowOnError extends boolean = false>(options: Options<GetAppaQuarantineData, ThrowOnError>) => (options.client ?? client).get<GetAppaQuarantineResponses, GetAppaQuarantineErrors, ThrowOnError>({ url: '/api/appa-quarantines/{id}', ...options });
 ...
 * `agentSettings:update`: Modify agent settings (default model, default agent, default tool guardrails, file uploads, Apps Hackathon recorder)
 */
export const acknowledgeAppaQuarantine = <ThrowOnError extends boolean = false>(options: Options<AcknowledgeAppaQuarantineData, ThrowOnError>) => (options.client ?? client).post<AcknowledgeAppaQuarantineResponses, AcknowledgeAppaQuarantineErrors, ThrowOnError>({
