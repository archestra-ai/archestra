...
| `toolAssignments[].enterpriseManagedConfig` | `object \| null` | No |  |
| `toolAssignments[].enterpriseManagedConfig.identityProviderId` | `string` | No |  |
| `toolAssignments[].enterpriseManagedConfig.resourceType` | `"mcp" \| "oauth_protected_resource" \| "secret" \| "service_account" \| "custom_http"` | No |  |
| `toolAssignments[].enterpriseManagedConfig.resourceIdentifier` | `string` | No |  |
| `toolAssignments[].enterpriseManagedConfig.requestedCredentialType` | `"id_jag" \| "bearer_token" \| "secret" \| "service_account" \| "opaque_json"` | No |  |
| `toolAssignments[].enterpriseManagedConfig.scopes` | `string[]` | No |  |
| `toolAssignments[].enterpriseManagedConfig.audience` | `string` | No |  |
| `toolAssignments[].enterpriseManagedConfig.clientIdOverride` | `string` | No |  |
| `toolAssignments[].enterpriseManagedConfig.tokenInjectionMode` | `"authorization_bearer" \| "raw_authorization" \| "header" \| "env" \| "body_field"` | No |  |
| `toolAssignments[].enterpriseManagedConfig.headerName` | `string` | No |  |
| `toolAssignments[].enterpriseManagedConfig.envVarName` | `string` | No |  |
| `toolAssignments[].enterpriseManagedConfig.bodyFieldName` | `string` | No |  |
| `toolAssignments[].enterpriseManagedConfig.responseFieldPath` | `string` | No |  |
| `toolAssignments[].enterpriseManagedConfig.fallbackMode` | `"fail_closed" \| "fallback_to_dynamic" \| "fallback_to_static"` | No |  |
| `toolAssignments[].enterpriseManagedConfig.cacheTtlSeconds` | `integer` | No |  |
| `toolAssignments[].credentialSourceMcpServerId` | `string \| null` | No | Optional explicit remote MCP installation to use as the credential source. Use this only when you want credentials to come from one specific installed MCP server instead of resolving them at call time. |
| `toolAssignments[].executionSourceMcpServerId` | `string \| null` | No | Optional explicit local MCP installation to run the tool on. Use this only when you want a local MCP tool to execute on one specific installed MCP server instead of resolving the execution target at call time. |
...
| `assignments[].enterpriseManagedConfig` | `object \| null` | No |  |
| `assignments[].enterpriseManagedConfig.identityProviderId` | `string` | No |  |
| `assignments[].enterpriseManagedConfig.resourceType` | `"mcp" \| "oauth_protected_resource" \| "secret" \| "service_account" \| "custom_http"` | No |  |
| `assignments[].enterpriseManagedConfig.resourceIdentifier` | `string` | No |  |
| `assignments[].enterpriseManagedConfig.requestedCredentialType` | `"id_jag" \| "bearer_token" \| "secret" \| "service_account" \| "opaque_json"` | No |  |
| `assignments[].enterpriseManagedConfig.scopes` | `string[]` | No |  |
| `assignments[].enterpriseManagedConfig.audience` | `string` | No |  |
| `assignments[].enterpriseManagedConfig.clientIdOverride` | `string` | No |  |
| `assignments[].enterpriseManagedConfig.tokenInjectionMode` | `"authorization_bearer" \| "raw_authorization" \| "header" \| "env" \| "body_field"` | No |  |
| `assignments[].enterpriseManagedConfig.headerName` | `string` | No |  |
| `assignments[].enterpriseManagedConfig.envVarName` | `string` | No |  |
| `assignments[].enterpriseManagedConfig.bodyFieldName` | `string` | No |  |
| `assignments[].enterpriseManagedConfig.responseFieldPath` | `string` | No |  |
| `assignments[].enterpriseManagedConfig.fallbackMode` | `"fail_closed" \| "fallback_to_dynamic" \| "fallback_to_static"` | No |  |
| `assignments[].enterpriseManagedConfig.cacheTtlSeconds` | `integer` | No |  |
| `assignments[].credentialSourceMcpServerId` | `string \| null` | No | Optional explicit remote MCP installation to use as the credential source. Use this only when you want credentials to come from one specific installed MCP server instead of resolving them at call time. |
| `assignments[].executionSourceMcpServerId` | `string \| null` | No | Optional explicit local MCP installation to run the tool on. Use this only when you want a local MCP tool to execute on one specific installed MCP server instead of resolving the execution target at call time. |
