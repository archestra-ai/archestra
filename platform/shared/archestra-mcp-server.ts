...
export const TOOL_LIST_SCHEDULED_TASKS_SHORT_NAME = "list_scheduled_tasks";
export const TOOL_UPDATE_SCHEDULED_TASK_SHORT_NAME = "update_scheduled_task";
export const TOOL_DELETE_SCHEDULED_TASK_SHORT_NAME = "delete_scheduled_task";
...
export const TOOL_LIST_SCHEDULED_TASKS_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_LIST_SCHEDULED_TASKS_SHORT_NAME}` as const;
export const TOOL_UPDATE_SCHEDULED_TASK_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_UPDATE_SCHEDULED_TASK_SHORT_NAME}` as const;
export const TOOL_DELETE_SCHEDULED_TASK_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_DELETE_SCHEDULED_TASK_SHORT_NAME}` as const;
