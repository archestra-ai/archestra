...
- `archestra-dev-testing` - use to decide whether a change needs a test and at which level (unit vs backend route-level integration vs MSW-backed frontend integration vs e2e), and to spot the "fluff test" anti-pattern. Start here before the level-specific testing skills.
