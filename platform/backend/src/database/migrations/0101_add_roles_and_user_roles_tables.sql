...
CREATE UNIQUE INDEX "role_org_id_name_unique" ON "role"("organization_id", "name");
...
CREATE UNIQUE INDEX "user_role_assignment_user_id_role_id_unique" ON "user_role_assignment"("user_id", "role_id");
