 ...
 * - Sends usage in a final chunk with empty choices[] when stream_options.include_usage is true
 * - Has extra reasoning_content field in delta (for deepseek-reasoner model)
 */
