...
export const TOOL_GET_MCP_SERVER_TOOLS_NAME = "get_mcp_server_tools";
export const TOOL_GET_PROFILE_NAME = "get_profile";
export const TOOL_BROWSE_WEB_NAME = "browse_web";
...
export const TOOL_GET_MCP_SERVER_TOOLS_FULL_NAME = `${ARCHESTRA_MCP_SERVER_NAME}${MCP_SERVER_TOOL_NAME_SEPARATOR}${TOOL_GET_MCP_SERVER_TOOLS_NAME}`;
export const TOOL_GET_PROFILE_FULL_NAME = `${ARCHESTRA_MCP_SERVER_NAME}${MCP_SERVER_TOOL_NAME_SEPARATOR}${TOOL_GET_PROFILE_NAME}`;
export const TOOL_BROWSE_WEB_FULL_NAME = `${ARCHESTRA_MCP_SERVER_NAME}${MCP_SERVER_TOOL_NAME_SEPARATOR}${TOOL_BROWSE_WEB_NAME}`;
