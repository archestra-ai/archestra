...
/**
 * Update WhatsApp chatops configuration
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `agentTrigger:update`: Modify agent trigger configurations
 */
export const updateWhatsAppChatOpsConfig = <ThrowOnError extends boolean = false>(options: Options<UpdateWhatsAppChatOpsConfigData, ThrowOnError>) => (options.client ?? client).put<UpdateWhatsAppChatOpsConfigResponses, UpdateWhatsAppChatOpsConfigErrors, ThrowOnError>({
...
/**
 * Get WhatsApp QR code and connection status
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `agentTrigger:read`: View agent trigger configurations (Slack, MS Teams, email)
 */
export const getWhatsAppQrCode = <ThrowOnError extends boolean = false>(options?: Options<GetWhatsAppQrCodeData, ThrowOnError>) => (options?.client ?? client).get<GetWhatsAppQrCodeResponses, GetWhatsAppQrCodeErrors, ThrowOnError>({ url: '/api/chatops/config/whatsapp/qr', ...options });
 ...
 * `agentTrigger:update`: Modify agent trigger configurations
 */
export const disconnectWhatsApp = <ThrowOnError extends boolean = false>(options?: Options<DisconnectWhatsAppData, ThrowOnError>) => (options?.client ?? client).post<DisconnectWhatsAppResponses, DisconnectWhatsAppErrors, ThrowOnError>({ url: '/api/chatops/config/whatsapp/disconnect', ...options });

export const switchWhatsAppAccount = <ThrowOnError extends boolean = false>(options?: Options<DisconnectWhatsAppData, ThrowOnError>) => (options?.client ?? client).post<DisconnectWhatsAppResponses, DisconnectWhatsAppErrors, ThrowOnError>({ url: '/api/chatops/config/whatsapp/switch-account', ...options });

export const deleteWhatsAppPhoneMapping = <ThrowOnError extends boolean = false>(options: Options<DeleteWhatsAppPhoneMappingData, ThrowOnError>) => (options.client ?? client).delete<DeleteWhatsAppPhoneMappingResponses, DisconnectWhatsAppErrors, ThrowOnError>({ url: '/api/chatops/config/whatsapp/phone-mapping/{phone}', ...options });
