 ...
 */
export const getAgentA2aDelegations = <ThrowOnError extends boolean = false>(options: Options<GetAgentA2aDelegationsData, ThrowOnError>) => (options.client ?? client).get<GetAgentA2aDelegationsResponses, GetAgentA2aDelegationsErrors, ThrowOnError>({ url: '/api/agents/{agentId}/a2a-delegations', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const syncAgentA2aDelegations = <ThrowOnError extends boolean = false>(options: Options<SyncAgentA2aDelegationsData, ThrowOnError>) => (options.client ?? client).post<SyncAgentA2aDelegationsResponses, SyncAgentA2aDelegationsErrors, ThrowOnError>({
...
/**
 * List configured outbound A2A agents.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Get one configured outbound A2A agent.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * None (no additional RBAC permission required)
 */
export const unpinAgent = <ThrowOnError extends boolean = false>(options: Options<UnpinAgentData, ThrowOnError>) => (options.client ?? client).delete<UnpinAgentResponses, UnpinAgentErrors, ThrowOnError>({ url: '/api/agents/{id}/pin', ...options });
 ...
 */
export const pinAgent = <ThrowOnError extends boolean = false>(options: Options<PinAgentData, ThrowOnError>) => (options.client ?? client).put<PinAgentResponses, PinAgentErrors, ThrowOnError>({ url: '/api/agents/{id}/pin', ...options });
...
/**
 * Get an internal agent's skill activation policy
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * None (no additional RBAC permission required)
 */
export const transferAgentOwnership = <ThrowOnError extends boolean = false>(options: Options<TransferAgentOwnershipData, ThrowOnError>) => (options.client ?? client).post<TransferAgentOwnershipResponses, TransferAgentOwnershipErrors, ThrowOnError>({
 ...
 * None (no additional RBAC permission required)
 */
export const readAgentWorkspaceFile = <ThrowOnError extends boolean = false>(options: Options<ReadAgentWorkspaceFileData, ThrowOnError>) => (options.client ?? client).get<ReadAgentWorkspaceFileResponses, ReadAgentWorkspaceFileErrors, ThrowOnError>({ url: '/api/agent-runs/{taskId}/workspace/files', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const writeAgentWorkspaceFile = <ThrowOnError extends boolean = false>(options: Options<WriteAgentWorkspaceFileData, ThrowOnError>) => (options.client ?? client).put<WriteAgentWorkspaceFileResponses, WriteAgentWorkspaceFileErrors, ThrowOnError>({
 ...
 * None (no additional RBAC permission required)
 */
export const deleteAgentWorkspace = <ThrowOnError extends boolean = false>(options: Options<DeleteAgentWorkspaceData, ThrowOnError>) => (options.client ?? client).delete<DeleteAgentWorkspaceResponses, DeleteAgentWorkspaceErrors, ThrowOnError>({ url: '/api/agent-runs/{taskId}/workspace', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const getAgentRuntimePreflight = <ThrowOnError extends boolean = false>(options: Options<GetAgentRuntimePreflightData, ThrowOnError>) => (options.client ?? client).get<GetAgentRuntimePreflightResponses, GetAgentRuntimePreflightErrors, ThrowOnError>({ url: '/api/agents/{id}/runtime/preflight', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const disconnectClaudeCodeAccount = <ThrowOnError extends boolean = false>(options: Options<DisconnectClaudeCodeAccountData, ThrowOnError>) => (options.client ?? client).delete<DisconnectClaudeCodeAccountResponses, DisconnectClaudeCodeAccountErrors, ThrowOnError>({ url: '/api/agents/{id}/runtime/claude-code/account', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const getClaudeCodeAccount = <ThrowOnError extends boolean = false>(options: Options<GetClaudeCodeAccountData, ThrowOnError>) => (options.client ?? client).get<GetClaudeCodeAccountResponses, GetClaudeCodeAccountErrors, ThrowOnError>({ url: '/api/agents/{id}/runtime/claude-code/account', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const completeClaudeCodeSignIn = <ThrowOnError extends boolean = false>(options: Options<CompleteClaudeCodeSignInData, ThrowOnError>) => (options.client ?? client).post<CompleteClaudeCodeSignInResponses, CompleteClaudeCodeSignInErrors, ThrowOnError>({
 ...
 * None (no additional RBAC permission required)
 */
export const getClaudeCodeModels = <ThrowOnError extends boolean = false>(options: Options<GetClaudeCodeModelsData, ThrowOnError>) => (options.client ?? client).get<GetClaudeCodeModelsResponses, GetClaudeCodeModelsErrors, ThrowOnError>({ url: '/api/agents/{id}/runtime/claude-code/models', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const deleteAgentRuntimeCredential = <ThrowOnError extends boolean = false>(options: Options<DeleteAgentRuntimeCredentialData, ThrowOnError>) => (options.client ?? client).delete<DeleteAgentRuntimeCredentialResponses, DeleteAgentRuntimeCredentialErrors, ThrowOnError>({ url: '/api/agents/{id}/runtime/credentials/{key}', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const setAgentRuntimeCredential = <ThrowOnError extends boolean = false>(options: Options<SetAgentRuntimeCredentialData, ThrowOnError>) => (options.client ?? client).put<SetAgentRuntimeCredentialResponses, SetAgentRuntimeCredentialErrors, ThrowOnError>({
 ...
 * None (no additional RBAC permission required)
 */
export const getAgentRuns = <ThrowOnError extends boolean = false>(options: Options<GetAgentRunsData, ThrowOnError>) => (options.client ?? client).get<GetAgentRunsResponses, GetAgentRunsErrors, ThrowOnError>({ url: '/api/agents/{id}/runs', ...options });

/**
 * Start a durable Agent Runtime session with this Agent
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * None (no additional RBAC permission required)
 */
export const startAgentRun = <ThrowOnError extends boolean = false>(options: Options<StartAgentRunData, ThrowOnError>) => (options.client ?? client).post<StartAgentRunResponses, StartAgentRunErrors, ThrowOnError>({
...
/**
 * List Agent Runtime runs started by this user
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * None (no additional RBAC permission required)
 */
export const getMyAgentRuns = <ThrowOnError extends boolean = false>(options?: Options<GetMyAgentRunsData, ThrowOnError>) => (options?.client ?? client).get<GetMyAgentRunsResponses, GetMyAgentRunsErrors, ThrowOnError>({ url: '/api/agent-runs', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const deleteAgentRun = <ThrowOnError extends boolean = false>(options: Options<DeleteAgentRunData, ThrowOnError>) => (options.client ?? client).delete<DeleteAgentRunResponses, DeleteAgentRunErrors, ThrowOnError>({ url: '/api/agent-runs/{taskId}', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const getMyAgentRun = <ThrowOnError extends boolean = false>(options: Options<GetMyAgentRunData, ThrowOnError>) => (options.client ?? client).get<GetMyAgentRunResponses, GetMyAgentRunErrors, ThrowOnError>({ url: '/api/agent-runs/{taskId}', ...options });

/**
 * Update one Agent Runtime started by this user
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * None (no additional RBAC permission required)
 */
export const updateAgentRun = <ThrowOnError extends boolean = false>(options: Options<UpdateAgentRunData, ThrowOnError>) => (options.client ?? client).patch<UpdateAgentRunResponses, UpdateAgentRunErrors, ThrowOnError>({
...
/**
 * Start a new Agent turn in an owned, retained workspace
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * None (no additional RBAC permission required)
 */
export const continueAgentRun = <ThrowOnError extends boolean = false>(options: Options<ContinueAgentRunData, ThrowOnError>) => (options.client ?? client).post<ContinueAgentRunResponses, ContinueAgentRunErrors, ThrowOnError>({
 ...
 * None (no additional RBAC permission required)
 */
export const cancelAgentRun = <ThrowOnError extends boolean = false>(options: Options<CancelAgentRunData, ThrowOnError>) => (options.client ?? client).post<CancelAgentRunResponses, CancelAgentRunErrors, ThrowOnError>({ url: '/api/agent-runs/{taskId}/cancel', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const startAgentWorkspaceTransfer = <ThrowOnError extends boolean = false>(options: Options<StartAgentWorkspaceTransferData, ThrowOnError>) => (options.client ?? client).post<StartAgentWorkspaceTransferResponses, StartAgentWorkspaceTransferErrors, ThrowOnError>({
 ...
 * None (no additional RBAC permission required)
 */
export const downloadAgentWorkspaceTransfer = <ThrowOnError extends boolean = false>(options: Options<DownloadAgentWorkspaceTransferData, ThrowOnError>) => (options.client ?? client).get<DownloadAgentWorkspaceTransferResponses, unknown, ThrowOnError>({ url: '/api/agent-workspace-transfers/{transferId}/content', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const uploadAgentWorkspaceTransfer = <ThrowOnError extends boolean = false>(options: Options<UploadAgentWorkspaceTransferData, ThrowOnError>) => (options.client ?? client).put<UploadAgentWorkspaceTransferResponses, UploadAgentWorkspaceTransferErrors, ThrowOnError>({ url: '/api/agent-workspace-transfers/{transferId}/content', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const getAppVersionSummaries = <ThrowOnError extends boolean = false>(options: Options<GetAppVersionSummariesData, ThrowOnError>) => (options.client ?? client).get<GetAppVersionSummariesResponses, GetAppVersionSummariesErrors, ThrowOnError>({ url: '/api/apps/{appId}/versions/summaries', ...options });
...
/**
 * Restore an immutable app version by copying its artifact forward as a new head version. History is never rewritten.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * None (no additional RBAC permission required)
 */
export const getClientConnectionInstaller = <ThrowOnError extends boolean = false>(options?: Options<GetClientConnectionInstallerData, ThrowOnError>) => (options?.client ?? client).get<GetClientConnectionInstallerResponses, unknown, ThrowOnError>({ url: '/api/client-connections/installer', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const startClientConnection = <ThrowOnError extends boolean = false>(options: Options<StartClientConnectionData, ThrowOnError>) => (options.client ?? client).post<StartClientConnectionResponses, StartClientConnectionErrors, ThrowOnError>({
 ...
 * None (no additional RBAC permission required)
 */
export const pollClientConnection = <ThrowOnError extends boolean = false>(options: Options<PollClientConnectionData, ThrowOnError>) => (options.client ?? client).post<PollClientConnectionResponses, PollClientConnectionErrors, ThrowOnError>({
 ...
 * None (no additional RBAC permission required)
 */
export const getClientConnection = <ThrowOnError extends boolean = false>(options: Options<GetClientConnectionData, ThrowOnError>) => (options.client ?? client).get<GetClientConnectionResponses, GetClientConnectionErrors, ThrowOnError>({ url: '/api/client-connections/{id}', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const decideClientConnection = <ThrowOnError extends boolean = false>(options: Options<DecideClientConnectionData, ThrowOnError>) => (options.client ?? client).post<DecideClientConnectionResponses, DecideClientConnectionErrors, ThrowOnError>({
...
/**
 * Get all label keys used by environments
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const environmentLabelKeys = <ThrowOnError extends boolean = false>(options?: Options<EnvironmentLabelKeysData, ThrowOnError>) => (options?.client ?? client).get<EnvironmentLabelKeysResponses, EnvironmentLabelKeysErrors, ThrowOnError>({ url: '/api/environments/labels/keys', ...options });

/**
 * Get all label values used by environments
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `environment:read`: View and list deployment environments
 */
export const environmentLabelValues = <ThrowOnError extends boolean = false>(options?: Options<EnvironmentLabelValuesData, ThrowOnError>) => (options?.client ?? client).get<EnvironmentLabelValuesResponses, EnvironmentLabelValuesErrors, ThrowOnError>({ url: '/api/environments/labels/values', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const annotateGuardrailsTool = <ThrowOnError extends boolean = false>(options: Options<AnnotateGuardrailsToolData, ThrowOnError>) => (options.client ?? client).post<AnnotateGuardrailsToolResponses, AnnotateGuardrailsToolErrors, ThrowOnError>({
...
/**
 * Get a session's fork lineage: the session it forks and the sessions forked from it. A fork is a new client session that starts from another session's history and guardrail state. `log:read` covers the caller's own sessions. `log:admin` covers all organization sessions when the client session ID identifies one caller. If multiple callers share that session ID, lineage is ambiguous and the request fails.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `log:read`: View your own LLM proxy and MCP tool call logs in the active organization
 */
export const getInteractionSessionLineage = <ThrowOnError extends boolean = false>(options: Options<GetInteractionSessionLineageData, ThrowOnError>) => (options.client ?? client).get<GetInteractionSessionLineageResponses, GetInteractionSessionLineageErrors, ThrowOnError>({ url: '/api/interactions/sessions/{sessionId}/lineage', ...options });
...
/**
 * Get all label keys used by knowledge bases
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeSource:read`: View Knowledge Bases and Connectors
 */
export const knowledgeBaseLabelKeys = <ThrowOnError extends boolean = false>(options?: Options<KnowledgeBaseLabelKeysData, ThrowOnError>) => (options?.client ?? client).get<KnowledgeBaseLabelKeysResponses, KnowledgeBaseLabelKeysErrors, ThrowOnError>({ url: '/api/knowledge-bases/labels/keys', ...options });

/**
 * Get all label values used by knowledge bases
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeSource:read`: View Knowledge Bases and Connectors
 */
export const knowledgeBaseLabelValues = <ThrowOnError extends boolean = false>(options?: Options<KnowledgeBaseLabelValuesData, ThrowOnError>) => (options?.client ?? client).get<KnowledgeBaseLabelValuesResponses, KnowledgeBaseLabelValuesErrors, ThrowOnError>({ url: '/api/knowledge-bases/labels/values', ...options });

/**
 * Get all label keys used by knowledge connectors
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeSource:read`: View Knowledge Bases and Connectors
 */
export const connectorLabelKeys = <ThrowOnError extends boolean = false>(options?: Options<ConnectorLabelKeysData, ThrowOnError>) => (options?.client ?? client).get<ConnectorLabelKeysResponses, ConnectorLabelKeysErrors, ThrowOnError>({ url: '/api/knowledge-base-connectors/labels/keys', ...options });

/**
 * Get all label values used by knowledge connectors
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeSource:read`: View Knowledge Bases and Connectors
 */
export const connectorLabelValues = <ThrowOnError extends boolean = false>(options?: Options<ConnectorLabelValuesData, ThrowOnError>) => (options?.client ?? client).get<ConnectorLabelValuesResponses, ConnectorLabelValuesErrors, ThrowOnError>({ url: '/api/knowledge-base-connectors/labels/values', ...options });
...
/**
 * Get all label keys used by knowledge files
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeSource:read`: View Knowledge Bases and Connectors
 */
export const knowledgeFileLabelKeys = <ThrowOnError extends boolean = false>(options?: Options<KnowledgeFileLabelKeysData, ThrowOnError>) => (options?.client ?? client).get<KnowledgeFileLabelKeysResponses, KnowledgeFileLabelKeysErrors, ThrowOnError>({ url: '/api/knowledge-files/labels/keys', ...options });

/**
 * Get all label values used by knowledge files
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeSource:read`: View Knowledge Bases and Connectors
 */
export const knowledgeFileLabelValues = <ThrowOnError extends boolean = false>(options?: Options<KnowledgeFileLabelValuesData, ThrowOnError>) => (options?.client ?? client).get<KnowledgeFileLabelValuesResponses, KnowledgeFileLabelValuesErrors, ThrowOnError>({ url: '/api/knowledge-files/labels/values', ...options });
 ...
 * `knowledgeSource:update`: Modify Knowledge Bases and Connectors
 */
export const upsertKnowledgeFile = <ThrowOnError extends boolean = false>(options: Options<UpsertKnowledgeFileData, ThrowOnError>) => (options.client ?? client).put<UpsertKnowledgeFileResponses, UpsertKnowledgeFileErrors, ThrowOnError>({
...
/**
 * Rename a document, move it, or change its labels. Who can read it is its permission grants; the retired `visibility` and `teamIds` fields are refused.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Create a knowledge file directory. A directory only organizes documents; the retired `visibility` and `teamIds` fields are refused.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Rename a directory. The retired `visibility` and `teamIds` fields are refused.
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Get all label keys used by limits
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `llmLimit:read`: View token usage limits
 */
export const limitLabelKeys = <ThrowOnError extends boolean = false>(options?: Options<LimitLabelKeysData, ThrowOnError>) => (options?.client ?? client).get<LimitLabelKeysResponses, LimitLabelKeysErrors, ThrowOnError>({ url: '/api/limits/labels/keys', ...options });

/**
 * Get all label values used by limits
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `llmLimit:read`: View token usage limits
 */
export const limitLabelValues = <ThrowOnError extends boolean = false>(options?: Options<LimitLabelValuesData, ThrowOnError>) => (options?.client ?? client).get<LimitLabelValuesResponses, LimitLabelValuesErrors, ThrowOnError>({ url: '/api/limits/labels/values', ...options });
...
/**
 * Get all label keys used by models
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const llmProviderModelLabelKeys = <ThrowOnError extends boolean = false>(options?: Options<LlmProviderModelLabelKeysData, ThrowOnError>) => (options?.client ?? client).get<LlmProviderModelLabelKeysResponses, LlmProviderModelLabelKeysErrors, ThrowOnError>({ url: '/api/llm-provider-models/labels/keys', ...options });

/**
 * Get all label values used by models
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `llmModel:read`: View synced LLM models and capabilities
 */
export const llmProviderModelLabelValues = <ThrowOnError extends boolean = false>(options?: Options<LlmProviderModelLabelValuesData, ThrowOnError>) => (options?.client ?? client).get<LlmProviderModelLabelValuesResponses, LlmProviderModelLabelValuesErrors, ThrowOnError>({ url: '/api/llm-provider-models/labels/values', ...options });
...
/**
 * Get all label keys used by LLM OAuth clients
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Get all label values used by LLM OAuth clients
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Get all label keys used by model provider API keys
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Get all label values used by model provider API keys
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
export const mcpGatewayGet = <ThrowOnError extends boolean = false>(options: Options<McpGatewayGetData, ThrowOnError>) => (options.client ?? client).get<unknown, McpGatewayGetErrors, ThrowOnError>({ url: '/v1/mcp/{profileId}', ...options });
...
export const mcpGatewaySseMessage = <ThrowOnError extends boolean = false>(options: Options<McpGatewaySseMessageData, ThrowOnError>) => (options.client ?? client).post<McpGatewaySseMessageResponses, McpGatewaySseMessageErrors, ThrowOnError>({
...
export const reportAgentRuntimeStatus = <ThrowOnError extends boolean = false>(options: Options<ReportAgentRuntimeStatusData, ThrowOnError>) => (options.client ?? client).post<ReportAgentRuntimeStatusResponses, ReportAgentRuntimeStatusErrors, ThrowOnError>({
...
/**
 * Get all label keys used by MCP OAuth clients
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Get all label values used by MCP OAuth clients
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Compact an OpenAI response (uses default agent)
 *
 * Authentication:
 *
 * This route accepts either an LLM provider API key or a Virtual API Key. See [LLM Proxy Authentication](/docs/platform-llm-proxy-authentication).
...
/**
 * Compact an OpenAI response for a specific agent
 *
 * Authentication:
 *
 * This route accepts either an LLM provider API key or a Virtual API Key. See [LLM Proxy Authentication](/docs/platform-llm-proxy-authentication).
 ...
 * None (no additional RBAC permission required)
 */
export const consultOpenappaBatteryHelper = <ThrowOnError extends boolean = false>(options: Options<ConsultOpenappaBatteryHelperData, ThrowOnError>) => (options.client ?? client).post<ConsultOpenappaBatteryHelperResponses, ConsultOpenappaBatteryHelperErrors, ThrowOnError>({
    url: '/api/openappa/helpers/{installId}/{externalName}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Get all label keys used by plugins
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const pluginLabelKeys = <ThrowOnError extends boolean = false>(options?: Options<PluginLabelKeysData, ThrowOnError>) => (options?.client ?? client).get<PluginLabelKeysResponses, PluginLabelKeysErrors, ThrowOnError>({ url: '/api/plugins/labels/keys', ...options });

/**
 * Get all label values used by plugins
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `plugin:read`: View plugins and their file metadata
 */
export const pluginLabelValues = <ThrowOnError extends boolean = false>(options?: Options<PluginLabelValuesData, ThrowOnError>) => (options?.client ?? client).get<PluginLabelValuesResponses, PluginLabelValuesErrors, ThrowOnError>({ url: '/api/plugins/labels/values', ...options });
...
/**
 * Get all label keys used by projects
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const projectLabelKeys = <ThrowOnError extends boolean = false>(options?: Options<ProjectLabelKeysData, ThrowOnError>) => (options?.client ?? client).get<ProjectLabelKeysResponses, ProjectLabelKeysErrors, ThrowOnError>({ url: '/api/projects/labels/keys', ...options });

/**
 * Get all label values used by projects
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `project:read`: View projects and your own sessions inside them
 */
export const projectLabelValues = <ThrowOnError extends boolean = false>(options?: Options<ProjectLabelValuesData, ThrowOnError>) => (options?.client ?? client).get<ProjectLabelValuesResponses, ProjectLabelValuesErrors, ThrowOnError>({ url: '/api/projects/labels/values', ...options });
 ...
 * `credential:read`: View saved credentials
 */
export const startGitHubUserConnection = <ThrowOnError extends boolean = false>(options: Options<StartGitHubUserConnectionData, ThrowOnError>) => (options.client ?? client).post<StartGitHubUserConnectionResponses, StartGitHubUserConnectionErrors, ThrowOnError>({ url: '/api/credentials/{key}/github/start', ...options });
 ...
 * `credential:read`: View saved credentials
 */
export const completeGitHubUserConnection = <ThrowOnError extends boolean = false>(options: Options<CompleteGitHubUserConnectionData, ThrowOnError>) => (options.client ?? client).post<CompleteGitHubUserConnectionResponses, CompleteGitHubUserConnectionErrors, ThrowOnError>({
...
/**
 * Get all label keys used by service accounts
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Get all label values used by service accounts
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Get all label keys used by skills
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Get all label values used by skills
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const getProxyCostStatistics = <ThrowOnError extends boolean = false>(options?: Options<GetProxyCostStatisticsData, ThrowOnError>) => (options?.client ?? client).get<GetProxyCostStatisticsResponses, GetProxyCostStatisticsErrors, ThrowOnError>({ url: '/api/statistics/llm-proxy', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const getUserPermissionSources = <ThrowOnError extends boolean = false>(options?: Options<GetUserPermissionSourcesData, ThrowOnError>) => (options?.client ?? client).get<GetUserPermissionSourcesResponses, GetUserPermissionSourcesErrors, ThrowOnError>({ url: '/api/user/permission-sources', ...options });
...
/**
 * Get all label keys used by virtual API keys
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Get all label values used by virtual API keys
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * None (no additional RBAC permission required)
 */
export const searchInitialPermissionSubjects = <ThrowOnError extends boolean = false>(options: Options<SearchInitialPermissionSubjectsData, ThrowOnError>) => (options.client ?? client).get<SearchInitialPermissionSubjectsResponses, SearchInitialPermissionSubjectsErrors, ThrowOnError>({ url: '/api/resource-permissions/{resource}/creation-subjects', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const getScopedCapabilities = <ThrowOnError extends boolean = false>(options?: Options<GetScopedCapabilitiesData, ThrowOnError>) => (options?.client ?? client).get<GetScopedCapabilitiesResponses, GetScopedCapabilitiesErrors, ThrowOnError>({ url: '/api/resource-permissions', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const searchResourcePermissionSubjects = <ThrowOnError extends boolean = false>(options: Options<SearchResourcePermissionSubjectsData, ThrowOnError>) => (options.client ?? client).get<SearchResourcePermissionSubjectsResponses, SearchResourcePermissionSubjectsErrors, ThrowOnError>({ url: '/api/resource-permissions/{resource}/{scope}/subjects', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const getResourcePermissions = <ThrowOnError extends boolean = false>(options: Options<GetResourcePermissionsData, ThrowOnError>) => (options.client ?? client).get<GetResourcePermissionsResponses, GetResourcePermissionsErrors, ThrowOnError>({ url: '/api/resource-permissions/{resource}/{scope}', ...options });
 ...
 * None (no additional RBAC permission required)
 */
export const updateResourcePermissions = <ThrowOnError extends boolean = false>(options: Options<UpdateResourcePermissionsData, ThrowOnError>) => (options.client ?? client).put<UpdateResourcePermissionsResponses, UpdateResourcePermissionsErrors, ThrowOnError>({
