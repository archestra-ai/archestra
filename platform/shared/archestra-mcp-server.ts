...
export const TOOL_CREATE_SCHEDULED_TASK_SHORT_NAME = "create_scheduled_task";
...
export const TOOL_CREATE_SCHEDULED_TASK_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_CREATE_SCHEDULED_TASK_SHORT_NAME}` as const;
