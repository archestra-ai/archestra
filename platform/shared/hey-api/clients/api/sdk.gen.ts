 ...
 * `organizationSettings:update`: Customize organization appearance, authentication, etc
 */
export const updateOrgK8sSettings = <ThrowOnError extends boolean = false>(options: Options<UpdateOrgK8sSettingsData, ThrowOnError>) => (options.client ?? client).patch<UpdateOrgK8sSettingsResponses, UpdateOrgK8sSettingsErrors, ThrowOnError>({
 ...
 * Authorization:
 *
 * `team:admin`: Team administrator access
 */
export const updateTeamK8sSettings = <ThrowOnError extends boolean = false>(options: Options<UpdateTeamK8sSettingsData, ThrowOnError>) => (options.client ?? client).patch<UpdateTeamK8sSettingsResponses, UpdateTeamK8sSettingsErrors, ThrowOnError>({
