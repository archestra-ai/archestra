 ...
 * None (no additional RBAC permission required)
 */
export const getMyDefaultLimitUsage = <ThrowOnError extends boolean = false>(options?: Options<GetMyDefaultLimitUsageData, ThrowOnError>) => (options?.client ?? client).get<GetMyDefaultLimitUsageResponses, GetMyDefaultLimitUsageErrors, ThrowOnError>({ url: '/api/limits/me/default-usage', ...options });
