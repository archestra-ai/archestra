 ...
 */
export const getConnectorRun = <ThrowOnError extends boolean = false>(options: Options<GetConnectorRunData, ThrowOnError>) => (options.client ?? client).get<GetConnectorRunResponses, GetConnectorRunErrors, ThrowOnError>({ url: '/api/knowledge-graphs/{kgId}/connectors/{id}/runs/{runId}', ...options });
