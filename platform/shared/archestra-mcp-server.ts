...
export const TOOL_LIST_MY_MEMORY_SHORT_NAME = "list_my_memory";
export const TOOL_PROPOSE_MEMORY_CANDIDATE_SHORT_NAME =
...
export const TOOL_LIST_MY_MEMORY_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_LIST_MY_MEMORY_SHORT_NAME}` as const;
export const TOOL_PROPOSE_MEMORY_CANDIDATE_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_PROPOSE_MEMORY_CANDIDATE_SHORT_NAME}` as const;
