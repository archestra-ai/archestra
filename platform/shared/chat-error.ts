...
/**
 * Perplexity API error types (from response body `error.type` field)
 * Perplexity uses string-based error types in OpenAI-compatible format
 * @see https://console.perplexity.com/docs/errors
 */
