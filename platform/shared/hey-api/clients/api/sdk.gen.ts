 ...
 */
export const getTokenPricing = <ThrowOnError extends boolean = false>(options?: Options<GetTokenPricingData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetTokenPricingResponses, GetTokenPricingErrors, ThrowOnError>({
 ...
 * Update token prices
 */
export const updateTokenPricing = <ThrowOnError extends boolean = false>(options: Options<UpdateTokenPricingData, ThrowOnError>) => {
    return (options.client ?? client).put<UpdateTokenPricingResponses, UpdateTokenPricingErrors, ThrowOnError>({
        url: '/api/token-pricing',
        ...options,
        headers: {
            'Content-Type': 'application/json',
