 ...
 */
export const getClusters = <ThrowOnError extends boolean = false>(options?: Options<GetClustersData, ThrowOnError>) => (options?.client ?? client).get<GetClustersResponses, GetClustersErrors, ThrowOnError>({ url: '/api/clusters', ...options });
 ...
 * `mcpServerInstallation:admin`: Approve or manage all MCP server installations
 */
export const deleteCluster = <ThrowOnError extends boolean = false>(options: Options<DeleteClusterData, ThrowOnError>) => (options.client ?? client).delete<DeleteClusterResponses, DeleteClusterErrors, ThrowOnError>({ url: '/api/clusters/{id}', ...options });
 ...
 * `mcpServerInstallation:admin`: Approve or manage all MCP server installations
 */
export const getCluster = <ThrowOnError extends boolean = false>(options: Options<GetClusterData, ThrowOnError>) => (options.client ?? client).get<GetClusterResponses, GetClusterErrors, ThrowOnError>({ url: '/api/clusters/{id}', ...options });
 ...
 * `mcpServerInstallation:admin`: Approve or manage all MCP server installations
 */
export const updateCluster = <ThrowOnError extends boolean = false>(options: Options<UpdateClusterData, ThrowOnError>) => (options.client ?? client).patch<UpdateClusterResponses, UpdateClusterErrors, ThrowOnError>({
    url: '/api/clusters/{id}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
/**
 * Test connection to a cluster's Kubernetes API
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `mcpServerInstallation:admin`: Approve or manage all MCP server installations
 */
export const testCluster = <ThrowOnError extends boolean = false>(options: Options<TestClusterData, ThrowOnError>) => (options.client ?? client).post<TestClusterResponses, TestClusterErrors, ThrowOnError>({ url: '/api/clusters/{id}/test', ...options });
