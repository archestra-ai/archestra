...
-- drizzle-migration-linter: reason=All constraints and indexes target the eight new empty APPA tables created in this migration. No existing tables, existing rows, or older writers are modified. Experimental databases with previously applied APPA migrations require explicit migration-history reconciliation before this publication branch is deployed.
CREATE TABLE "appa_approvals" (
...
CREATE TABLE "appa_opaque_history_items" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"session_id" uuid NOT NULL,
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "appa_opaque_history_items_payload_bytes_check" CHECK ("appa_opaque_history_items"."canonical_payload_bytes" >= 0)
);
--> statement-breakpoint
CREATE TABLE "appa_opaque_history_windows" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"session_id" uuid NOT NULL,
	"provider" text NOT NULL,
	"protocol" text NOT NULL,
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "appa_opaque_history_windows_frame_version_check" CHECK ("appa_opaque_history_windows"."frame_version" >= 0)
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "appa_approvals" ADD CONSTRAINT "appa_approvals_session_id_appa_proxy_sessions_id_fk" FOREIGN KEY ("session_id") REFERENCES "public"."appa_proxy_sessions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "appa_opaque_history_items" ADD CONSTRAINT "appa_opaque_history_items_session_id_appa_proxy_sessions_id_fk" FOREIGN KEY ("session_id") REFERENCES "public"."appa_proxy_sessions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "appa_opaque_history_items" ADD CONSTRAINT "appa_opaque_history_items_window_id_appa_opaque_history_windows_id_fk" FOREIGN KEY ("window_id") REFERENCES "public"."appa_opaque_history_windows"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "appa_opaque_history_windows" ADD CONSTRAINT "appa_opaque_history_windows_session_id_appa_proxy_sessions_id_fk" FOREIGN KEY ("session_id") REFERENCES "public"."appa_proxy_sessions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "appa_opaque_history_windows" ADD CONSTRAINT "appa_opaque_history_windows_parent_window_id_appa_opaque_history_windows_id_fk" FOREIGN KEY ("parent_window_id") REFERENCES "public"."appa_opaque_history_windows"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "appa_approvals_org_status_idx" ON "appa_approvals" USING btree ("organization_id","status");--> statement-breakpoint
CREATE INDEX "appa_approvals_session_turn_idx" ON "appa_approvals" USING btree ("session_id","active_turn_id");--> statement-breakpoint
CREATE UNIQUE INDEX "appa_opaque_history_items_scope_provider_item_uidx" ON "appa_opaque_history_items" USING btree ("session_id","provider","protocol","model","provider_item_id") WHERE "appa_opaque_history_items"."provider_item_id" is not null;--> statement-breakpoint
CREATE UNIQUE INDEX "appa_opaque_history_items_scope_identity_uidx" ON "appa_opaque_history_items" USING btree ("session_id","provider","protocol","model","identity_hash");--> statement-breakpoint
CREATE INDEX "appa_opaque_history_items_window_idx" ON "appa_opaque_history_items" USING btree ("window_id");--> statement-breakpoint
CREATE INDEX "appa_opaque_history_items_session_turn_idx" ON "appa_opaque_history_items" USING btree ("session_id","source_turn_id");--> statement-breakpoint
CREATE UNIQUE INDEX "appa_opaque_history_items_server_identity_uidx" ON "appa_opaque_history_items" USING btree ("server_identity");--> statement-breakpoint
CREATE UNIQUE INDEX "appa_opaque_history_windows_scope_window_uidx" ON "appa_opaque_history_windows" USING btree ("session_id","provider","protocol","model","provider_window_id");--> statement-breakpoint
CREATE UNIQUE INDEX "appa_opaque_history_windows_session_frame_uidx" ON "appa_opaque_history_windows" USING btree ("session_id","frame_version");--> statement-breakpoint
CREATE INDEX "appa_opaque_history_windows_session_turn_idx" ON "appa_opaque_history_windows" USING btree ("session_id","source_turn_id");--> statement-breakpoint
CREATE UNIQUE INDEX "appa_opaque_history_windows_bound_item_uidx" ON "appa_opaque_history_windows" USING btree ("session_id","bound_by_server_identity") WHERE "appa_opaque_history_windows"."bound_by_server_identity" is not null;--> statement-breakpoint
...
CREATE UNIQUE INDEX "appa_proxy_wire_frames_control_uidx" ON "appa_proxy_wire_frames" USING btree ("control_call_id");
