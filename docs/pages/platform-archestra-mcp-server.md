...
| `list_agent_executions` | List recent executions across one or more accessible Agents for a read-only operations dashboard. | `agent:read` |
...
| `post_task_file` | Upload a file into the messaging-channel thread a task reports to — a demo recording, for example — so it renders natively there (Slack plays video uploads inline). | `agent:read` |
...
| `executions[].task_id` | `string` | Yes |  |
| `executions[].title` | `string` | Yes |  |
| `executions[].prompt` | `string` | Yes |  |
| `executions[].state` | `string` | Yes |  |
| `executions[].status_reason` | `string \| null` | Yes |  |
| `executions[].started_at` | `string` | Yes |  |
| `executions[].ended_at` | `string \| null` | Yes |  |
| `executions[].state_changed_at` | `string \| null` | Yes |  |
| `executions[].agent` | `object` | Yes |  |
| `executions[].agent.id` | `string` | Yes |  |
| `executions[].agent.name` | `string` | Yes |  |
| `executions[].agent.icon` | `string \| null` | Yes |  |
| `executions[].requester` | `object` | Yes |  |
| `executions[].requester.kind` | `string` | Yes |  |
| `executions[].requester.id` | `string` | Yes |  |
| `executions[].requester.name` | `string \| null` | Yes |  |
| `executions[].execution_url` | `string` | Yes |  |
| `executions[].thread` | `object \| null` | Yes |  |
| `executions[].thread.provider` | `string` | Yes |  |
| `executions[].thread.channel_id` | `string` | Yes |  |
| `executions[].thread.channel_name` | `string \| null` | Yes |  |
| `executions[].thread.thread_id` | `string` | Yes |  |
| `executions[].thread.url` | `string \| null` | Yes |  |
| `summary` | `object` | Yes |  |
