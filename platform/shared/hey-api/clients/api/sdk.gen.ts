 ...
 * None (no additional RBAC permission required)
 */
export const getUserResourceAccess = <ThrowOnError extends boolean = false>(options?: Options<GetUserResourceAccessData, ThrowOnError>) => (options?.client ?? client).get<GetUserResourceAccessResponses, GetUserResourceAccessErrors, ThrowOnError>({ url: '/api/user/resource-access', ...options });
